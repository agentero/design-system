...
export const checkboxRecipe = tv({
	slots: {
		root: [
			'group box-border inline-flex size-4 shrink-0 appearance-none items-center justify-center rounded-sm',
			'border border-solid border-border-input-default bg-bg-input-normal',
			'cursor-pointer transition-colors duration-200 ease-in-out',
			'data-[state=checked]:border-bg-default-base-inverse-primary data-[state=checked]:bg-bg-default-base-inverse-primary',
			'data-[state=indeterminate]:border-bg-default-base-inverse-primary data-[state=indeterminate]:bg-bg-default-base-inverse-primary',
			...
			'disabled:data-[state=checked]:border-bg-default-neutral-tertiary disabled:data-[state=checked]:bg-bg-default-neutral-tertiary',
			'disabled:data-[state=indeterminate]:border-bg-default-neutral-tertiary disabled:data-[state=indeterminate]:bg-bg-default-neutral-tertiary',
			'aria-invalid:disabled:border-border-input-disable',
			'aria-invalid:disabled:data-[state=checked]:border-bg-default-neutral-tertiary aria-invalid:disabled:data-[state=checked]:bg-bg-default-neutral-tertiary',
			'aria-invalid:disabled:data-[state=indeterminate]:border-bg-default-neutral-tertiary aria-invalid:disabled:data-[state=indeterminate]:bg-bg-default-neutral-tertiary'
		],
	...
	return (
		<CheckboxPrimitive.Root
			...
			<CheckboxPrimitive.Indicator data-slot="checkbox-indicator" className={styles.indicator()}>
				<IconCheck className="hidden size-3.5 group-data-[state=checked]:block" />
				<IconMinus className="hidden size-3.5 group-data-[state=indeterminate]:block" />
