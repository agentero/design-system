...
const meta = {
  ...
  argTypes: {
    children: {
      control: "text",
      description:
        "Button content. Accepts text, icon elements, or both — text runs are wrapped in a truncating `<span data-slot=\"button-label\">` so the label ellipsizes without shrinking adjacent icons.",
      table: {
