import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{d as t}from"./iframe-j0J0zb8a.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./switch-BCOXoQ9b.js";var a,o,s,c,l,u,d,f,p,m,h;function g(){return(g=e((()=>{a=t(),r(),o=n(),s={title:`Components/Switch`,component:i,tags:[`autodocs`],argTypes:{size:{control:`radio`,options:[`sm`,`md`]},checked:{control:`boolean`},disabled:{control:`boolean`}},args:{size:`md`,disabled:!1},parameters:{docs:{description:{component:`Two-state toggle for a setting that takes effect immediately. Prefer it over
