import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n}from"./iframe-j0J0zb8a.js";import{t as r}from"./react-dom-Bb5HHOcK.js";import{t as i}from"./jsx-runtime-DeHZSEgm.js";import{n as a,t as o}from"./dist-C8AlzbfS.js";import{n as s,t as c}from"./utils-nsk-j2e0.js";import{i as l,r as u}from"./dist-BaylodoK.js";import{n as d,t as f}from"./button-03NyQdKn.js";var p,m,h;function g(){return(g=t((()=>{p=e(n(),1),r(),l(),m=i(),h=[`a`,`button`,`div`,`form`,`h2`,`h3`,`img`,`input`,`label`,`li`,`nav`,`ol`,`p`,`select`,`span`,`svg`,`ul`].reduce((e,t)=>{let n=u(`Primitive.${t}`),r=p.forwardRef((e,r)=>{let{asChild:i,...a}=e,o=i?n:t;return typeof window<`u`&&(window[Symbol.for(`radix-ui`)]=!0),(0,m.jsx)(o,{...a,ref:r})});return r.displayName=`Primitive.${t}`,{...e,[t]:r}},{})})))()}function _(e){return S.includes(e)}var v,y,b,x,S,C,w;function T(){return(T=t((()=>{v=e(n(),1),g(),y=i(),b=`Separator`,x=`horizontal`,S=[`horizontal`,`vertical`],C=v.forwardRef((e,t)=>{let{decorative:n,orientation:r=x,...i}=e,a=_(r)?r:x,o=n?{role:`none`}:{"aria-orientation":a===`vertical`?a:void 0,role:`separator`};return(0,y.jsx)(h.div,{"data-orientation":a,...o,...i,ref:t})}),C.displayName=b,w=C})))()}var E,D,O;function k(){return(k=t((()=>{T(),o(),s(),E=i(),D=a({slots:{root:[`shrink-0`],label:[`flex text-text-default-base-tertiary`]},variants:{orientation:{horizontal:{root:[`w-full`]},vertical:{root:[`h-auto`]}},hasLabel:{true:{root:[`flex items-center text-sm`,`before:flex-1 before:content-[""] before:border-border-default-base-primary`,`after:flex-1 after:content-[""] after:border-border-default-base-primary`]},false:{root:[`bg-border-default-base-primary`]}}},compoundVariants:[{orientation:`horizontal`,hasLabel:!1,class:{root:`h-px w-full`}},{orientation:`vertical`,hasLabel:!1,class:{root:`h-auto w-px`}},{orientation:`horizontal`,hasLabel:!0,class:{root:`before:mr-2 before:border-t after:ml-2 after:border-t`,label:`px-10`}},{orientation:`vertical`,hasLabel:!0,class:{root:`flex-col before:mb-2 before:border-l after:mt-2 after:border-l`,label:`py-2`}}],defaultVariants:{orientation:`horizontal`,hasLabel:!1}}),O=({className:e,orientation:t=`horizontal`,decorative:n=!0,label:r,ref:i,...a})=>{let o=r!=null,s=D({orientation:t,hasLabel:o});return(0,E.jsx)(w,{ref:i,"data-slot":`separator`,decorative:n,orientation:t,className:c(s.root(),e),...a,children:o&&(0,E.jsx)(`div`,{className:s.label(),children:r})})};try{D.displayName=`dividerRecipe`,D.__docgenInfo={description:"Style recipe for Divider using tailwind-variants.\nDefines slots (`root`, `label`) and variants (`orientation`, `hasLabel`).\nThe labelless case renders a single 1px line via `bg-border-default-base-primary`;\nthe labelled case flanks the label with two 1px pseudo-element lines via\n`border-border-default-base-primary`. Label text routes through\n`text-text-default-base-tertiary`.",displayName:`dividerRecipe`,filePath:`/home/runner/work/design-system/design-system/src/divider/divider.tsx`,methods:[],props:{orientation:{defaultValue:{value:`horizontal`},description:``,name:`orientation`,required:!1,tags:{},type:{name:`enum`,raw:`"horizontal" | "vertical"`,value:[{value:`"horizontal"`},{value:`"vertical"`}]}},hasLabel:{defaultValue:null,description:``,name:`hasLabel`,required:!1,tags:{},type:{name:`boolean`}},class:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`},{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`}],description:``,name:`class`,required:!1,tags:{},type:{name:`ClassNameValue`}},className:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`},{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`}],description:``,name:`className`,required:!1,tags:{},type:{name:`ClassNameValue`}}},tags:{summary:`Tailwind-variants recipe for the Divider component`}}}catch{}try{O.displayName=`Divider`,O.__docgenInfo={description:`Divider separates content visually (or semantically, via \`decorative={false}\`)
...
meaning (visual or semantic section break), not whitespace.`,displayName:`Divider`,filePath:`/home/runner/work/design-system/design-system/src/divider/divider.tsx`,methods:[],props:{asChild:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/@radix-ui/react-avatar/node_modules/@radix-ui/react-primitive/dist/index.d.mts`,name:`TypeLiteral`}],description:``,name:`asChild`,required:!1,tags:{},type:{name:`boolean`}},label:{defaultValue:null,declarations:[{fileName:`design-system/src/divider/divider.tsx`,name:`TypeLiteral`}],description:`Optional label rendered inline between two flanking 1px lines. When set,
Divider renders a styled \`<div>\` (rather than the underlying separator
primitive) so the label can sit centered between the two line segments.`,name:`label`,required:!1,tags:{},type:{name:`ReactNode`}}},tags:{summary:`Visual or semantic separator that optionally renders a centered label`,param:"orientation - Axis along which the separator renders. Defaults to `'horizontal'`.\n- `horizontal` — 1px line spanning the parent width.\n- `vertical` — 1px line spanning the parent height; parent must establish a height.\ndecorative - When `true` (default), the separator is purely visual and hidden\nfrom assistive technologies. Set to `false` to expose `role=\"separator\"` plus\n`aria-orientation` for meaningful section breaks.\nlabel - Optional inline content rendered between two flanking 1px lines.\nWhen omitted, Divider renders a single line.",example:`<Divider />
<Divider orientation="vertical" />
<Divider label="or" />
<Divider decorative={false} />`}}}catch{}})))()}var A,j,M,N,P,F,I,L,R,z,B,V,H;function U(){return(U=t((()=>{s(),d(),k(),A=i(),j={title:`Components/Divider`,component:O,tags:[`autodocs`],argTypes:{orientation:{control:`radio`,options:[`horizontal`,`vertical`]},decorative:{control:`boolean`},label:{control:`text`}},args:{orientation:`horizontal`,decorative:!0},parameters:{docs:{description:{component:`Divider separates content visually along either a horizontal or vertical
...
@summary Horizontal dividers between stacked list rows`,...R.parameters?.docs?.description}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  render: () => <div className="inline-flex h-10 items-center gap-1 rounded-lg border border-border-default-base-primary bg-bg-default-base-primary px-2 shadow-xs">
