import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./button-BLFbN8Nc.js";import{n as i,t as a}from"./field-D2p0JeL3.js";import{a as o,i as s,n as c,o as l,r as u,t as d}from"./form-BIiAwW5E.js";var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;function B(){return(B=e((()=>{o(),s(),n(),i(),c(),f=t(),{expect:p,fn:m,userEvent:h,waitFor:g,within:_}=__STORYBOOK_MODULE_TEST__,v={title:`Components/FormText`,component:u,tags:[`autodocs`],argTypes:{name:{control:!1},orientation:{control:`radio`,options:[`vertical`,`horizontal`,`responsive`]},label:{control:`text`},description:{control:`text`},tooltip:{control:`text`},required:{control:`boolean`},optional:{control:`boolean`},disabled:{control:`boolean`},readOnly:{control:`boolean`}},args:{name:`agencyName`,label:`Agency name`,orientation:`vertical`,required:!0,optional:!1,disabled:!1,readOnly:!1},parameters:{docs:{description:{component:"FormText is a complete text field bound to one react-hook-form value: label,\n`Input`, helper text and validation error in the standard order, wired\nthrough `useController`. It renders inside a `Form.Root` and needs only a\n`name`; `required`, `invalid` and the error reach the label, the input's\n`aria-*` attributes and the message with no ids written by hand.\n\nIt covers the common case. For another layout — an input with addons, a\ndifferent control, a message rendered elsewhere — compose `useController`\nwith the `FieldText`, `Label`, `Input` and `Field.*` primitives directly."}}}},y=m(),b=e=>{let t=l({defaultValues:{agencyName:``}});return(0,f.jsxs)(d.Root,{methods:t,onSubmit:y,"aria-label":`Agency`,className:`flex flex-col items-start gap-7`,children:[(0,f.jsx)(u,{rules:{required:`Enter the agency name.`},inputProps:{placeholder:`Acme Insurance`},...e,name:`agencyName`}),(0,f.jsx)(r,{type:`submit`,children:`Save`})]})},x={parameters:{docs:{source:{code:`const methods = useForm<AgencyValues>({ defaultValues: { agencyName: '' } });
...
</Form.Root>`}}},render:e=>(0,f.jsx)(b,{...e}),play:async({canvasElement:e})=>{y.mockClear();let t=_(e),n=t.getByRole(`textbox`,{name:`Agency name`});await p(n).toBeRequired(),await p(n).toHaveAttribute(`name`,`agencyName`),await p(t.queryByRole(`alert`)).toBeNull(),await h.click(t.getByRole(`button`,{name:`Save`})),await p(await t.findByRole(`alert`)).toHaveTextContent(`Enter the agency name.`),await p(n).toHaveAttribute(`aria-invalid`,`true`),await p(y).not.toHaveBeenCalled(),await h.type(n,`Acme Insurance`),await g(()=>p(t.queryByRole(`alert`)).toBeNull()),await p(n).not.toHaveAttribute(`aria-invalid`),await h.click(t.getByRole(`button`,{name:`Save`})),await g(()=>p(y).toHaveBeenCalledWith({agencyName:`Acme Insurance`},p.anything()))}},S=()=>{let e=l({defaultValues:{taxId:``}});return(0,f.jsx)(d.Root,{methods:e,"aria-label":`Tax details`,children:(0,f.jsx)(u,{name:`taxId`,label:`Tax ID`,tooltip:`The EIN the IRS issued to the agency.`,description:`Nine digits, with or without the dash.`,inputProps:{inputMode:`numeric`,autoComplete:`off`}})})},C={parameters:{docs:{source:{code:`const methods = useForm<TaxValues>({ defaultValues: { taxId: '' } });
...
<Form.Root methods={methods} aria-label="Tax details">
  ...
  />
</Form.Root>`}}},render:()=>(0,f.jsx)(S,{}),play:async({canvasElement:e})=>{let t=_(e),n=t.getByRole(`textbox`,{name:`Tax ID`}),r=t.getByRole(`button`,{name:`More information`});await p(n).toHaveAccessibleDescription(`Nine digits, with or without the dash.`),await p(r.closest(`label`)).toBeNull()}},w=()=>{let e=l({defaultValues:{phone:``}});return(0,f.jsx)(d.Root,{methods:e,"aria-label":`Contact`,children:(0,f.jsx)(u,{name:`phone`,label:`Phone number`,optional:!0,inputProps:{type:`tel`}})})},T={parameters:{docs:{source:{code:`const methods = useForm<PhoneValues>({ defaultValues: { phone: '' } });

<Form.Root methods={methods} aria-label="Contact">
  <FormText name="phone" label="Phone number" optional inputProps={{ type: 'tel' }} />
</Form.Root>`}}},render:()=>(0,f.jsx)(w,{}),play:async({canvasElement:e})=>{let t=_(e),n=t.getByRole(`textbox`,{name:`Phone number`});await p(n).not.toBeRequired(),await p(t.getByText(`Phone number`)).toHaveClass(/after:content-/)}},E=()=>{let e=l({defaultValues:{agency:{npn:``}}});return(0,f.jsxs)(d.Root,{methods:e,onSubmit:y,"aria-label":`License`,className:`flex flex-col items-start gap-7`,children:[(0,f.jsx)(u,{name:`agency.npn`,label:`NPN`,rules:{required:`Enter your NPN.`,pattern:{value:/^\d{6,10}$/,message:`An NPN is 6 to 10 digits.`}},inputProps:{inputMode:`numeric`}}),(0,f.jsx)(r,{type:`submit`,children:`Save`})]})},D={parameters:{docs:{source:{code:`const methods = useForm<LicenseValues>({ defaultValues: { agency: { npn: '' } } });
...
<Form.Root
  ...
  />
  <Button type="submit">Save</Button>
</Form.Root>`}}},render:()=>(0,f.jsx)(E,{}),play:async({canvasElement:e})=>{y.mockClear();let t=_(e),n=t.getByRole(`textbox`,{name:`NPN`}),r=t.getByRole(`button`,{name:`Save`});await p(n).toHaveAttribute(`name`,`agency.npn`),await p(n).not.toBeRequired(),await p(t.queryByText(`*`)).toBeNull(),await h.click(r),await p(await t.findByRole(`alert`)).toHaveTextContent(`Enter your NPN.`),await h.type(n,`abc`),await h.click(r),await p(await t.findByRole(`alert`)).toHaveTextContent(`An NPN is 6 to 10 digits.`),await p(y).not.toHaveBeenCalled(),await h.clear(n),await h.type(n,`1234567`),await h.click(r),await g(()=>p(y).toHaveBeenCalledWith({agency:{npn:`1234567`}},p.anything())),await p(t.queryByRole(`alert`)).toBeNull()}},O=()=>{let e=l({defaultValues:{password:``},criteriaMode:`all`});return(0,f.jsxs)(d.Root,{methods:e,onSubmit:y,"aria-label":`Account security`,className:`flex flex-col items-start gap-7`,children:[(0,f.jsx)(u,{name:`password`,label:`Password`,required:!0,inputProps:{type:`password`},rules:{required:`Enter a password.`,validate:{uppercase:e=>/[A-Z]/.test(e)||`At least one uppercase letter.`,number:e=>/[0-9]/.test(e)||`At least one number.`,length:e=>e.length>=10||`At least 10 characters.`}}}),(0,f.jsx)(r,{type:`submit`,children:`Save`})]})},k={parameters:{docs:{source:{code:`// criteriaMode: 'all' collects every rule that failed, not just the first.
...
</Form.Root>`}}},render:()=>(0,f.jsx)(N,{}),play:async({canvasElement:e})=>{let t=_(e),n=e=>e.getBoundingClientRect(),r=t.getByTestId(`short`),i=t.getByTestId(`long`),a=t.getByRole(`textbox`,{name:`Full name`}),o=t.getByRole(`textbox`,{name:`Title`});await p(r).toHaveAttribute(`data-orientation`,`horizontal`),await p(a).toHaveClass(`w-72`),await p(a).toHaveValue(`Rafa Moro`),await p(n(a).left).toBe(n(o).left),await p(Math.round(n(a).right)).toBe(Math.round(n(r).right)),await p(n(t.getByText(`Full name`)).right).toBeLessThanOrEqual(n(a).left);let s=i.querySelector(`[data-slot=field-description]`);await p(n(s).top).toBeGreaterThanOrEqual(n(o).bottom),await p(o).toHaveAccessibleDescription(`Shown on your public profile.`)}},F=()=>{let e=l({defaultValues:{agencyId:`AG-48213`,email:`ops@acme-insurance.com`}});return(0,f.jsxs)(d.Root,{methods:e,onSubmit:y,"aria-label":`Account`,className:`flex flex-col items-start gap-7`,children:[(0,f.jsxs)(a.Group,{children:[(0,f.jsx)(u,{name:`agencyId`,label:`Agency ID`,disabled:!0}),(0,f.jsx)(u,{name:`email`,label:`Email`,inputProps:{type:`email`}})]}),(0,f.jsx)(r,{type:`submit`,children:`Save`})]})},I={parameters:{docs:{source:{code:`const methods = useForm<AccountValues>({
...
<Form.Root
  ...
  <Button type="submit">Save</Button>
</Form.Root>`}}},render:()=>(0,f.jsx)(F,{}),play:async({canvasElement:e})=>{y.mockClear();let t=_(e),n=t.getByRole(`textbox`,{name:`Agency ID`});await p(n).toBeDisabled(),await p(n.closest(`[data-slot=field]`)).toHaveAttribute(`data-disabled`),await p(t.getByRole(`textbox`,{name:`Email`})).toBeEnabled(),await h.click(t.getByRole(`button`,{name:`Save`})),await g(()=>p(y).toHaveBeenCalledWith({agencyId:`AG-48213`,email:`ops@acme-insurance.com`},p.anything()))}},L=()=>{let e=l({defaultValues:{agencyName:``,phone:``}});return(0,f.jsxs)(d.Root,{methods:e,"aria-label":`Agency contact`,className:`flex flex-col items-start gap-7`,children:[(0,f.jsxs)(a.Group,{children:[(0,f.jsx)(u,{name:`agencyName`,label:`Agency name`}),(0,f.jsx)(u,{name:`phone`,label:`Phone number`,inputProps:{type:`tel`}})]}),(0,f.jsx)(r,{type:`button`,variant:`secondary`,onClick:()=>e.setFocus(`phone`),children:`Focus phone`})]})},R={parameters:{docs:{source:{code:`const methods = useForm<AgencyValues & PhoneValues>({
