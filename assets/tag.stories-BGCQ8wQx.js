...
}`,...L.parameters?.docs?.source},description:{story:"Full matrix: every variant for every color, repeated as default, as `pill`,\nas an interactive `asChild` `<button>`, with a single leading icon, with\nleading + trailing icons, and icon-only.\n\n@summary Variant × color matrix — default, pill, button, and icon layouts",...L.parameters?.docs?.description}}},R=[`Default`,`Sizes`,`Styles`,`Interactive`,`Secondary`,`Tertiary`,`Ghost`,`Invisible`,`WithIcon`,`Truncate`,`Colors`]}))();export{L as Colors,D as Default,N as Ghost,A as Interactive,P as Invisible,j as Secondary,O as Sizes,k as Styles,M as Tertiary,I as Truncate,F as WithIcon,R as __namedExportsOrder,E as default};