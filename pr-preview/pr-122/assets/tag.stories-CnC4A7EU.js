...
}`,...F.parameters?.docs?.source},description:{story:`\`truncate\` caps the Tag at its container's width and ellipsizes the label.
...
@summary Long labels capped at the container width with an ellipsis`,...F.parameters?.docs?.description}}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    width: '9rem',
...
}`,...I.parameters?.docs?.source},description:{story:`Without \`truncate\`, a Tag never wraps its label onto multiple lines — a
...
@summary A too-narrow container overflows a single-line Tag; the label never wraps`,...I.parameters?.docs?.description}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '4rem',
    flexWrap: 'wrap'
...
}`,...L.parameters?.docs?.source},description:{story:"Full matrix: every variant for every color, repeated as default, as `pill`,\nas an interactive `asChild` `<button>`, with a single leading icon, with\nleading + trailing icons, and icon-only.\n\n@summary Variant × color matrix — default, pill, button, and icon layouts",...L.parameters?.docs?.description}}},R=[`Default`,`Sizes`,`Styles`,`Interactive`,`Secondary`,`Tertiary`,`Ghost`,`Invisible`,`WithIcon`,`Truncate`,`OverflowsWithoutWrapping`,`Colors`]})))()}z();export{L as Colors,E as Default,M as Ghost,k as Interactive,N as Invisible,I as OverflowsWithoutWrapping,A as Secondary,D as Sizes,O as Styles,j as Tertiary,F as Truncate,P as WithIcon,R as __namedExportsOrder,T as default};