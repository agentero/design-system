...
to the ghost token ramp for lower visual weight.`,name:`ghost`,required:!1,type:{name:`boolean`}}}}}catch{}try{C.Title.displayName=`Alert.Title`,C.Title.__docgenInfo={description:`Renders a styled heading inside an Alert. The element inherits size from
the parent Alert and its id is wired to the root's \`aria-labelledby\`
so assistive tech announces the title as the accessible name.`,displayName:`Alert.Title`,props:{}}}catch{}try{C.Paragraph.displayName=`Alert.Paragraph`,C.Paragraph.__docgenInfo={description:`Renders a body paragraph inside an Alert. Inherits size from the parent
Alert context and contributes to the accessible description.`,displayName:`Alert.Paragraph`,props:{}}}catch{}try{C.ParagraphHtml.displayName=`Alert.ParagraphHtml`,C.ParagraphHtml.__docgenInfo={description:"Renders raw HTML inside an Alert paragraph slot via\n`dangerouslySetInnerHTML`. The caller is responsible for sanitizing the\n`html` string before passing it in — this component does not escape or\nfilter content.",displayName:`Alert.ParagraphHtml`,props:{html:{defaultValue:null,description:``,name:`html`,required:!0,type:{name:`string`}}}}}catch{}try{C.Content.displayName=`Alert.Content`,C.Content.__docgenInfo={description:`Groups title and paragraph content inside an Alert. Applies the context
size's gap and flex column layout to keep title + paragraphs stacked
with consistent spacing.`,displayName:`Alert.Content`,props:{}}}catch{}try{C.Actions.displayName=`Alert.Actions`,C.Actions.__docgenInfo={description:`Container for action buttons pinned to the right edge of the Alert,
vertically centered. Use alongside \`Alert.Content\` to place actions
opposite the main message.`,displayName:`Alert.Actions`,props:{}}}catch{}try{C.Button.displayName=`Alert.Button`,C.Button.__docgenInfo={description:'Link-styled button that inherits the Alert\'s text color. Equivalent to\n`<Button variant="link" className="text-current" />` — consumer props\nare spread last so every prop (including `variant` and `className`\nbeyond the default `text-current`) is overridable.',displayName:`Alert.Button`,props:{children:{defaultValue:null,description:`Content rendered inside the Button. Accepts a text label, icon elements,
...
across all variants.`,name:`status`,required:!1,type:{name:`enum`,value:[{value:`"danger"`}]}},loading:{defaultValue:null,description:'When `true`, shows a spinner overlay and forces the button into a disabled\nstate to block further interaction. Not supported with `variant="link"` —\npassing both logs a dev-only warning (silent in production).',name:`loading`,required:!1,type:{name:`boolean`}},disabled:{defaultValue:null,description:"Disables interaction and applies the disabled color treatment. Applied\nvia className so it still affects anchors rendered via `asChild`, which\nignore the native `disabled` attribute — in that case `aria-disabled`\nand `data-disabled` are forwarded to the child element instead.",name:`disabled`,required:!1,type:{name:`boolean`}},iconOnly:{defaultValue:null,description:"Forces the icon-only layout (square aspect ratio, no min-width). Useful\nwith `asChild` where the single wrapper child prevents auto-detection.\nFor non-`asChild` usage, prefer passing icon elements as children — the\nicon-only layout is applied automatically.",name:`iconOnly`,required:!1,type:{name:`boolean`}},rounded:{defaultValue:null,description:"When `true`, renders a fully pill-shaped button (rounded-full). Otherwise\nuses the variant's default corner radius.",name:`rounded`,required:!1,type:{name:`boolean`}},align:{defaultValue:null,description:"Justifies children along the main axis. Defaults to `'center'`.\nUse `'justify'` to push leading and trailing icons to the edges.",name:`align`,required:!1,type:{name:`enum`,value:[{value:`"center"`},{value:`"start"`},{value:`"end"`},{value:`"justify"`}]}},fitContent:{defaultValue:null,description:"When `true`, removes the per-size `min-width` floor so the button hugs\nits content. Useful for inline actions inside tight containers.",name:`fitContent`,required:!1,type:{name:`boolean`}},ref:{defaultValue:null,description:"Ref forwarded to the underlying element. Typed as a union covering both\n`<button>` and `<a>` because `asChild` lets consumers render either tag\n(or any forwardRef component) through Radix's `Slot`.",name:`ref`,required:!1,type:{name:`Ref<HTMLButtonElement | HTMLAnchorElement>`}},asChild:{defaultValue:null,description:"When `true`, Button clones its single child element and merges\nButton's `className`, `ref`, and event handlers onto it rather than\nrendering a `<button>`. Use this to style any element (a plain `<a>`,\na framework `Link`, a `React.forwardRef` component) as a Button.\n\nWhen combined with `disabled`, Button emits `aria-disabled` and\n`data-disabled` on the child instead of the native `disabled`\nattribute (which is ignored by non-form-control elements).",name:`asChild`,required:!1,type:{name:`boolean`}}}}}catch{}try{C.Pictograms.displayName=`Alert.Pictograms`,C.Pictograms.__docgenInfo={description:"Container for a 64×64 pictogram/illustration rendered inside an Alert.\nForces any `<svg>` descendant to render at 64px square.",displayName:`Alert.Pictograms`,props:{}}}catch{}})),w,T,fe,E,D,O,pe,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,me;t((()=>{c(),de(),w=r(),{expect:T,fn:fe,userEvent:E,within:D}=__STORYBOOK_MODULE_TEST__,O=[`neutral`,`success`,`danger`,`warning`,`info`,`creative`,`dynamic`,`playful`],pe=[`sm`,`md`],k=({children:e})=>(0,w.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`1rem`},children:e}),A={title:`Components/Alert`,component:C,tags:[`autodocs`],argTypes:{color:{control:`select`,options:O},size:{control:`radio`,options:pe},ghost:{control:`boolean`},hasIcon:{control:`boolean`},onDismiss:{control:`boolean`},icon:{control:`select`,options:[`default`,`star`,`check`,`error`,`info`,`warning`],mapping:{default:void 0,star:o,check:l,error:i,info:a,warning:s}}},args:{color:`neutral`,size:`sm`,ghost:!1,hasIcon:!0},render:({onDismiss:e,...t})=>(0,w.jsx)(C,{...t,onDismiss:e?()=>{}:void 0,children:(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:`Title`}),(0,w.jsx)(C.Paragraph,{children:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`})]})}),parameters:{docs:{description:{component:"Alert surfaces feedback about outcomes or state changes — success, danger,\nwarning, or info. Compose it from `Alert.Content`, `Alert.Title`,\n`Alert.Paragraph`, `Alert.Actions`, and `Alert.Button` to build the layout\nyour flow needs. Eight colors, two sizes, and a ghost mode cover most\nfeedback scenarios."}}}},j={},M={args:{color:`neutral`}},N={args:{color:`success`}},P={args:{color:`danger`}},F={args:{color:`warning`}},I={args:{color:`info`}},L={args:{color:`creative`}},R={args:{color:`dynamic`}},z={args:{color:`playful`}},B={args:{color:`danger`,ghost:!0}},V={args:{size:`sm`}},H={args:{size:`md`}},U={args:{color:`warning`,onDismiss:fe()},argTypes:{onDismiss:{control:!1,action:`onDismiss`}},render:e=>(0,w.jsx)(C,{...e,children:(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:`Title`}),(0,w.jsx)(C.Paragraph,{children:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`})]})}),play:async({canvasElement:e,args:t})=>{let n=D(e),r=n.getByRole(`alert`);await T(r).toHaveAttribute(`data-slot`,`alert-root`),await T(r).toHaveAccessibleName(`Title`);let i=n.getByRole(`button`,{name:`Dismiss`});await E.click(i),await T(t.onDismiss).toHaveBeenCalledTimes(1)}},W={args:{color:`info`},render:({onDismiss:e,...t})=>(0,w.jsxs)(C,{...t,onDismiss:e?()=>{}:void 0,children:[(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:`Update available`}),(0,w.jsx)(C.Paragraph,{children:`Reload to apply the latest version.`})]}),(0,w.jsx)(C.Actions,{children:(0,w.jsx)(C.Button,{onClick:()=>{},children:`Reload`})})]})},G={args:{color:`warning`,size:`md`,onDismiss:(()=>{})},render:({onDismiss:e,...t})=>(0,w.jsxs)(C,{...t,onDismiss:e?()=>{}:void 0,children:[(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:`Session expiring`}),(0,w.jsx)(C.Paragraph,{children:`Renew to continue editing.`})]}),(0,w.jsx)(C.Actions,{children:(0,w.jsx)(C.Button,{onClick:()=>{},children:`Renew session`})})]})},K={args:{color:`info`,hasIcon:!1}},q={args:{color:`creative`,icon:ee}},J={args:{color:`success`},render:({onDismiss:e,...t})=>(0,w.jsx)(C,{...t,onDismiss:e?()=>{}:void 0,children:(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:`Formatted content`}),(0,w.jsx)(C.ParagraphHtml,{html:`Review the <strong>terms</strong> or <a href='https://example.com'>read the docs</a>.`})]})})},Y={args:{color:`info`,hasIcon:!1,size:`md`},render:({onDismiss:e,...t})=>(0,w.jsxs)(C,{...t,onDismiss:e?()=>{}:void 0,children:[(0,w.jsx)(C.Pictograms,{children:(0,w.jsxs)(`svg`,{viewBox:`0 0 64 64`,xmlns:`http://www.w3.org/2000/svg`,"aria-hidden":!0,children:[(0,w.jsx)(`circle`,{cx:`32`,cy:`32`,r:`28`,fill:`currentColor`,opacity:`0.15`}),(0,w.jsx)(`circle`,{cx:`32`,cy:`32`,r:`14`,fill:`currentColor`})]})}),(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:`Pictogram example`}),(0,w.jsx)(C.Paragraph,{children:`Pictograms scale to 64×64px regardless of the configured size.`})]})]})},X={args:{color:`neutral`},render:({onDismiss:e,...t})=>(0,w.jsx)(C,{...t,onDismiss:e?()=>{}:void 0,children:(0,w.jsx)(C.Paragraph,{children:`This field is required.`})})},Z={args:{color:`success`},render:({onDismiss:e,...t})=>(0,w.jsx)(C,{...t,onDismiss:e?()=>{}:void 0,children:(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:`Upload complete`}),(0,w.jsx)(C.Paragraph,{children:`12 documents were added to the policy.`}),(0,w.jsx)(`div`,{children:(0,w.jsx)(C.Button,{onClick:()=>{},children:`View documents`})})]})})},Q={render:()=>(0,w.jsx)(k,{children:O.map(e=>(0,w.jsx)(C,{color:e,children:(0,w.jsxs)(C.Content,{children:[(0,w.jsx)(C.Title,{children:e}),(0,w.jsxs)(C.Paragraph,{children:[`This is a `,e,` alert variant with the default icon.`]})]})},e))})},$={render:()=>(0,w.jsx)(k,{children:O.map(e=>(0,w.jsx)(C,{color:e,ghost:!0,children:(0,w.jsxs)(C.Content,{children:[(0,w.jsxs)(C.Title,{children:[e,` (ghost)`]}),(0,w.jsxs)(C.Paragraph,{children:[`This is a `,e,` ghost alert variant with the ghost icon color.`]})]})},e))})},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{}`,...j.parameters?.docs?.source},description:{story:"Args-controlled playground. Toggle `color`, `size`, `ghost`, `hasIcon`, and\n`onDismiss` from the Controls panel to explore every visual combination.\n\n@summary Default args playground for Alert",...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  args: {
    color: 'neutral'
  }
...
@summary Visual comparison of all Alert colors in ghost mode`,...$.parameters?.docs?.description}}},me=[`Default`,`Neutral`,`Success`,`Danger`,`Warning`,`Info`,`Creative`,`Dynamic`,`Playful`,`Ghost`,`SmallSize`,`MediumSize`,`WithDismiss`,`WithActions`,`WithDismissAndAction`,`WithoutIcon`,`WithCustomIcon`,`WithParagraphHtml`,`WithPictograms`,`OnlyParagraph`,`WithActionsBelow`,`AllColors`,`AllGhostColors`]}))();export{Q as AllColors,$ as AllGhostColors,L as Creative,P as Danger,j as Default,R as Dynamic,B as Ghost,I as Info,H as MediumSize,M as Neutral,X as OnlyParagraph,z as Playful,V as SmallSize,N as Success,F as Warning,W as WithActions,Z as WithActionsBelow,q as WithCustomIcon,U as WithDismiss,G as WithDismissAndAction,J as WithParagraphHtml,Y as WithPictograms,K as WithoutIcon,me as __namedExportsOrder,A as default};