import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-D16BNjX-.js";import{n,t as r}from"./icons-DIsc_dNu.js";var i,a,o,s,c;e((()=>{n(),i=t(),a=Object.entries(r).filter(([e,t])=>e.startsWith(`Icon`)&&typeof t==`function`),o={title:`Components/Icons`,argTypes:{size:{control:{type:`number`,min:16,max:96,step:4}}},args:{size:24},parameters:{docs:{description:{component:"Visual gallery of every icon exported from `@agentero/design-system/icons`.\nAdding a new icon (drop SVG → `yarn gen:icons` → re-export from `index.ts`)\nmakes it appear here automatically; no story file to write.\n\n@summary Auto-discovered grid of all design-system icons"}}}},s={render:({size:e})=>(0,i.jsx)(`div`,{className:`grid grid-cols-[repeat(auto-fill,minmax(140px,1fr))] gap-6 p-4 text-text-default-base-primary`,children:a.map(([t,n])=>(0,i.jsxs)(`div`,{className:`flex flex-col items-center gap-2 rounded-md border border-border-default-base-primary p-4`,children:[(0,i.jsx)(n,{size:e}),(0,i.jsx)(`code`,{className:`text-xs`,children:t})]},t))})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: ({
    size
  }) => <div className="grid grid-cols-[repeat(auto-fill,minmax(140px,1fr))] gap-6 p-4 text-text-default-base-primary">
            {icons.map(([name, Icon]) => <div key={name} className="flex flex-col items-center gap-2 rounded-md border border-border-default-base-primary p-4">
                    <Icon size={size} />
...
range. The icon color is driven by the surrounding \`currentColor\`.
