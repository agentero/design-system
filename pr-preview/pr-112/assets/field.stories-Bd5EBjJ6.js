...
}`,...k.parameters?.docs?.source},description:{story:`\`Field.Group\` stacks fields and owns the space between them. Each field gets
its own ids, so several on one page never collide.

@summary Several fields stacked in a group`,...k.parameters?.docs?.description}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
...
}`,...A.parameters?.docs?.source},description:{story:"Outside a `Field.Root` every part reads a `null` context and works on its own\nprops alone: `Label` needs its `htmlFor`, `Field.Error` its own `id`.\n\n@summary Label and Field.Error used without a Field.Root",...A.parameters?.docs?.description}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => <Field.Root>
...
}`,...j.parameters?.docs?.source},description:{story:"A context is a default, never an override: an explicit `htmlFor` or `id` on a\npart wins over what `Field.Root` provides.\n\n@summary Explicit props on a part win over the field's context",...j.parameters?.docs?.description}}},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
...
}`,...P.parameters?.docs?.source},description:{story:"What a form adapter does with these contexts, simulated with `useState` and\nno form library: it re-provides `ErrorContext` with the field's errors so a\nbare `<Field.Error />` renders them. A `FieldText` adapter extends\n`InputContext` the same way with `value`, `onChange`, `onBlur` and `name`.\n\n@summary Form-adapter extension point simulated without a form library",...P.parameters?.docs?.description}}},F=[`Default`,`Required`,`Optional`,`WithTooltip`,`Invalid`,`MultipleErrors`,`NoError`,`Disabled`,`Horizontal`,`Group`,`StandaloneOutsideField`,`OwnPropsWin`,`FormAdapterSimulation`]}))();export{b as Default,D as Disabled,P as FormAdapterSimulation,k as Group,O as Horizontal,w as Invalid,T as MultipleErrors,E as NoError,S as Optional,j as OwnPropsWin,x as Required,A as StandaloneOutsideField,C as WithTooltip,F as __namedExportsOrder,v as default};