...
}`,...I.parameters?.docs?.source},description:{story:"`FieldContext` is an extension point: re-provided under the root with the\nerrors, a bare `<Field.Error />` renders them — here with `useState` and no\nform library. `InputContext` extends the same way with `value`, `onChange`,\n`onBlur` and `name`; see `FieldText`.\n\n@summary Errors supplied to a bare Field.Error through context",...I.parameters?.docs?.description}}},L=[`Default`,`Required`,`Optional`,`WithTooltip`,`Invalid`,`MultipleErrors`,`NoError`,`Disabled`,`ReadOnly`,`Horizontal`,`Responsive`,`Group`,`StandaloneOutsideField`,`OwnPropsWin`,`ErrorsFromContext`]}))();export{b as Default,D as Disabled,I as ErrorsFromContext,j as Group,k as Horizontal,w as Invalid,T as MultipleErrors,E as NoError,S as Optional,N as OwnPropsWin,O as ReadOnly,x as Required,A as Responsive,M as StandaloneOutsideField,C as WithTooltip,L as __namedExportsOrder,v as default};