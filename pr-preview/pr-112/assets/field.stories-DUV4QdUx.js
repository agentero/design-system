...
@summary Several errors rendered as a de-duplicated list`,...T.parameters?.docs?.description}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    await expect(rect(settingsControl).left).toBeGreaterThanOrEqual(rect(settingsDescription).right);
...
}`,...k.parameters?.docs?.source},description:{story:"`horizontal` puts the label beside the control at every width. Wrap the\ncontrol and its messages in `Field.Content` so they stack on the right; wrap\na label and its description in `Field.Content` too when they share the left\nside, as in a settings row. A bare `Label` gets the same placement as\n`Field.Label`.\n\n@summary Horizontal field, one row at every width",...k.parameters?.docs?.description}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-8">
            <div className="w-[40rem]" data-testid="wide">
