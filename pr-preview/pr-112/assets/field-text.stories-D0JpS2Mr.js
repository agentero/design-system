...
}`,...j.parameters?.docs?.source},description:{story:`\`readOnly\` on the field reaches the input through context. The value stays
focusable, copyable and submitted, and the input looks like any other.

@summary Read-only field driven from the root`,...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
