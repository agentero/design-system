...
makes a click focus the control — render it as a sibling instead.`,displayName:`Label`,filePath:`/home/runner/work/design-system/design-system/src/label/label.tsx`,methods:[],props:{asChild:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/cmdk/node_modules/@radix-ui/react-primitive/dist/index.d.mts`,name:`TypeLiteral`}],description:``,name:`asChild`,required:!1,tags:{},type:{name:`boolean`}},optional:{defaultValue:{value:`false`},declarations:[{fileName:`design-system/src/label/label.tsx`,name:`TypeLiteral`}],description:'Appends a muted " (optional)" suffix. Ignored when `required` is set.',name:`optional`,required:!1,tags:{},type:{name:`boolean`}},required:{defaultValue:{value:`false`},declarations:[{fileName:`design-system/src/label/label.tsx`,name:`TypeLiteral`}],description:"Appends a decorative asterisk. Mark the control itself `required` too — the asterisk is `aria-hidden`.",name:`required`,required:!1,tags:{},type:{name:`boolean`}}},tags:{summary:`Accessible caption for a form control`,example:`<Label htmlFor="phone" optional>Phone number</Label>
<Input id="phone" type="tel" />`}}}catch{}})),G,K,q,J,Y,X,Z,Q,$;e((()=>{oe(),G=i(),{expect:K,within:q}=__STORYBOOK_MODULE_TEST__,J={title:`Components/Label`,component:W,tags:[`autodocs`],argTypes:{optional:{control:`boolean`},required:{control:`boolean`}},args:{children:`Email`},parameters:{docs:{description:{component:"Label is the accessible caption for a form control, built on Radix's Label\nprimitive: it associates with the control through `htmlFor` and does not select\ntext on double-click.\n\n`optional` and `required` are display-only affordances — the control itself\nstill has to carry `required` / `aria-required`."}}}},Y={args:{htmlFor:`email`},render:e=>(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(W,{...e}),(0,G.jsx)(`input`,{id:`email`,placeholder:`you@example.com`})]}),play:async({canvasElement:e})=>{await K(q(e).getByLabelText(`Email`)).toBeInTheDocument()}},X={args:{optional:!0,children:`Phone number`}},Z={args:{required:!0,children:`Full name`},play:async({canvasElement:e})=>{let t=q(e);await K(t.getByText(`Full name`)).toBeInTheDocument(),await K(t.getByText(`*`)).toHaveAttribute(`aria-hidden`,`true`)}},Q={args:{optional:!0,required:!0,children:`Agency name`},play:async({canvasElement:e})=>{let t=q(e);await K(t.getByText(`*`)).toBeInTheDocument(),await K(t.getByText(`Agency name`)).not.toHaveClass(/after:content/)}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
  args: {
    htmlFor: 'email'
  },
  render: args => <>
