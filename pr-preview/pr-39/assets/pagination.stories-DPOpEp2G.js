...
that are split across pages.`}}}},D={},O={args:{currentPage:2,totalCount:30,pageSize:10}},k={args:{currentPage:2,totalCount:1e3,pageSize:10}},A={args:{currentPage:99,totalCount:1e3,pageSize:10}},j={args:{currentPage:50,totalCount:1e3,pageSize:10}},M={args:{currentPage:100,totalCount:1e3,pageSize:10}},N={render:({totalCount:e,pageSize:t})=>{let[n,r]=(0,w.useState)(1);return(0,T.jsx)(S,{currentPage:n,totalCount:e,pageSize:t,onPageChange:r})}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{}`,...D.parameters?.docs?.source},description:{story:`Default args playground. The first page of a 1,000-item list paged 10 at a
time — renders pages 1–5, an ellipsis, and the last page (100), with the
previous-page button disabled because we're on page 1.

@summary Default args playground for Pagination`,...D.parameters?.docs?.description}}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  args: {
    currentPage: 2,
    totalCount: 30,
    pageSize: 10
  }
}`,...O.parameters?.docs?.source},description:{story:`Short list whose total pages fit in the visible window — no ellipsis is
rendered. Exercises the \`totalPageNumbers >= totalPageCount\` branch in
\`getPages\`.

@summary Short page list with no ellipsis collapse`,...O.parameters?.docs?.description}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
    currentPage: 2,
    totalCount: 1000,
    pageSize: 10
  }
}`,...k.parameters?.docs?.source},description:{story:`Current page sits near the start of the range — left ellipsis is hidden,
right ellipsis is shown, and the last page button anchors the right edge.

@summary Right-side ellipsis only (current page near start)`,...k.parameters?.docs?.description}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    currentPage: 99,
    totalCount: 1000,
    pageSize: 10
  }
}`,...A.parameters?.docs?.source},description:{story:`Current page sits near the end of the range — left ellipsis is shown, right
ellipsis is hidden, and the first page button anchors the left edge.

@summary Left-side ellipsis only (current page near end)`,...A.parameters?.docs?.description}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  args: {
    currentPage: 50,
    totalCount: 1000,
    pageSize: 10
  }
}`,...j.parameters?.docs?.source},description:{story:`Current page sits in the middle of the range — both ellipses are visible,
with the first and last page buttons anchoring each edge.

@summary Both ellipses visible (current page in middle)`,...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  args: {
    currentPage: 100,
    totalCount: 1000,
    pageSize: 10
  }
}`,...M.parameters?.docs?.source},description:{story:`Last page selected — the next-page button is disabled and the active page
indicator sits on the trailing number.

@summary Last page selected with disabled next button`,...M.parameters?.docs?.description}}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  render: ({
    totalCount,
    pageSize
  }) => {
...
}`,...N.parameters?.docs?.source},description:{story:`Interactive controlled example. Local \`useState\` owns the page; clicking a
page, previous, or next button updates it so the active page indicator and
entries summary follow along.

@summary Interactive controlled example backed by \`useState\``,...N.parameters?.docs?.description}}},P=[`Default`,`FewPages`,`DotsRight`,`DotsLeft`,`DotsBoth`,`LastPage`,`Controlled`]}))();export{N as Controlled,D as Default,j as DotsBoth,A as DotsLeft,k as DotsRight,O as FewPages,M as LastPage,P as __namedExportsOrder,E as default};