...
}`,...R.parameters?.docs?.source},description:{story:`The \`photo\` type is the default. The image fills the avatar shape edge-to-edge,
which is ideal for user profile photographs.

@summary Photo type fills the avatar shape edge-to-edge`,...R.parameters?.docs?.description}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'initials',
    fallback: 'JD'
  }
}`,...z.parameters?.docs?.source},description:{story:`The \`initials\` type is intended when no image is available and the avatar
stands in for a user with their initials. The fallback text is centered
within the avatar shape.

@summary Initials type for users without a profile photo`,...z.parameters?.docs?.description}}},B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'isotype',
    variant: 'square',
...
}`,...B.parameters?.docs?.source},description:{story:`The \`isotype\` type renders the image smaller than the avatar shape so a
...
@summary Isotype type centers a brand icon inside the shape`,...B.parameters?.docs?.description}}},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: '1rem'
...
}`,...V.parameters?.docs?.source},description:{story:"All content types shown side by side: `photo` fills the shape, `initials`\ncenters text, and `isotype` shrinks a brand icon inside the bounding shape.\n\n@summary Visual comparison of all avatar content types",...V.parameters?.docs?.description}}},H.parameters={...H.parameters,docs:{...H.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: '1rem'
...
}`,...H.parameters?.docs?.source},description:{story:`The isotype icon scales proportionally smaller than the avatar shape at
every size, keeping a consistent inset around the logo from \`xs\` (24px)
to \`4xl\` (128px).

@summary Isotype scaling across all avatar sizes`,...H.parameters?.docs?.description}}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'xs',
    fallback: 'XS'
  }
...
@summary All avatar shapes with a profile image`,...Q.parameters?.docs?.description}}},$=[`Default`,`WithImage`,`WithFallbackInitials`,`Circle`,`Square`,`Pillow`,`Pentagon`,`TypePhoto`,`TypeInitials`,`TypeIsotype`,`AllTypes`,`AllSizesIsotype`,`SizeXs`,`SizeSm`,`SizeLg`,`SizeXl`,`Colorized`,`AllColorized`,`AllSizes`,`AllSizesWithImage`,`AllVariants`,`AllVariantsWithImage`]}))();export{J as AllColorized,Y as AllSizes,H as AllSizesIsotype,X as AllSizesWithImage,V as AllTypes,Z as AllVariants,Q as AllVariantsWithImage,P as Circle,q as Colorized,j as Default,L as Pentagon,I as Pillow,G as SizeLg,W as SizeSm,K as SizeXl,U as SizeXs,F as Square,z as TypeInitials,B as TypeIsotype,R as TypePhoto,N as WithFallbackInitials,M as WithImage,$ as __namedExportsOrder,Ae as default};