import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{D as n}from"./iframe-Bup55jiH.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{n as i,t as a}from"./label-CJUbS1Ah.js";import{i as o,n as s,r as c,t as l}from"./input-s8UmhQGH.js";import{i as u,t as d}from"./input-BrIKR5JJ.js";import{n as f,t as p}from"./field-text-9A6Me-1g.js";var m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{m=t(n(),1),p(),c(),l(),a(),h=r(),{expect:g,fn:_,userEvent:v,waitFor:y,within:b}=__STORYBOOK_MODULE_TEST__,x={title:`Components/FieldText`,component:f,tags:[`autodocs`],argTypes:{orientation:{control:`radio`,options:[`vertical`,`horizontal`,`responsive`]},invalid:{control:`boolean`},disabled:{control:`boolean`},readOnly:{control:`boolean`},required:{control:`boolean`}},args:{orientation:`vertical`,invalid:!1,disabled:!1,readOnly:!1,required:!1},parameters:{docs:{description:{component:"FieldText is a `Field.Root` for a single-line text control. It provides\n`InputContext`, so the `Input` inside associates itself with the label and\nthe messages and takes `invalid`, `required`, `disabled` and `readOnly` from\nthe field — no `id`, `htmlFor`, `aria-describedby` or `aria-invalid` written\nby hand.\n\nIt knows nothing about form libraries, and its contexts compose: a provider\nnested inside it can extend `InputContext` with `value`, `onChange`, `onBlur`\nand `name`, and `FieldContext` with the errors, as the last story shows."}}}},S={render:e=>(0,h.jsxs)(f,{...e,children:[(0,h.jsx)(i,{children:`Email`}),(0,h.jsx)(d,{type:`email`,placeholder:`you@example.com`}),(0,h.jsx)(s.Description,{children:`We only use this to send policy documents.`})]}),play:async({canvasElement:e})=>{let t=b(e).getByRole(`textbox`,{name:`Email`});await g(t).toHaveAttribute(`data-slot`,`input`),await g(t).toHaveAccessibleDescription(`We only use this to send policy documents.`),await g(t).not.toHaveAttribute(`aria-invalid`)}},C={args:{required:!0},render:e=>(0,h.jsxs)(f,{...e,children:[(0,h.jsx)(i,{children:`Full name`}),(0,h.jsx)(d,{placeholder:`Jane Doe`})]}),play:async({canvasElement:e})=>{let t=b(e);await g(t.getByRole(`textbox`,{name:`Full name`})).toBeRequired(),await g(t.getByText(`*`)).toHaveAttribute(`aria-hidden`,`true`)}},w={args:{invalid:!0},render:e=>(0,h.jsxs)(f,{...e,children:[(0,h.jsx)(i,{children:`Email`}),(0,h.jsx)(d,{type:`email`,defaultValue:`not-an-email`}),(0,h.jsx)(s.Error,{errors:[{message:`Enter a valid email address.`}]})]}),play:async({canvasElement:e})=>{let t=b(e),n=t.getByRole(`textbox`,{name:`Email`}),r=t.getByRole(`alert`);await g(n).toHaveAttribute(`aria-invalid`,`true`),await g(n).toHaveAttribute(`aria-describedby`,g.stringContaining(r.id)),await g(e.querySelector(`[data-slot=field][data-invalid="true"]`)).not.toBeNull()}},T={args:{disabled:!0},render:e=>(0,h.jsxs)(f,{...e,children:[(0,h.jsx)(i,{children:`Agency`}),(0,h.jsx)(d,{defaultValue:`Acme Insurance`})]}),play:async({canvasElement:e})=>{await g(b(e).getByRole(`textbox`,{name:`Agency`})).toBeDisabled()}},E={args:{readOnly:!0},render:e=>(0,h.jsxs)(f,{...e,children:[(0,h.jsx)(i,{children:`Policy number`}),(0,h.jsx)(d,{defaultValue:`POL-2049-118`}),(0,h.jsx)(s.Description,{children:`Assigned by the carrier; contact support to change it.`})]}),play:async({canvasElement:e})=>{let t=b(e).getByRole(`textbox`,{name:`Policy number`});await g(t).toHaveAttribute(`readonly`),await g(t).not.toBeDisabled()}},D={render:e=>(0,h.jsxs)(`div`,{className:`flex flex-col gap-2`,children:[(0,h.jsxs)(f,{...e,children:[(0,h.jsx)(i,{children:`Website`}),(0,h.jsx)(d,{type:`url`,size:`lg`,className:`max-w-xs`,"aria-describedby":`website-hint`}),(0,h.jsx)(s.Description,{children:`Include the protocol.`})]}),(0,h.jsx)(`p`,{id:`website-hint`,className:`text-sm`,children:`Shown on your public profile.`})]}),play:async({canvasElement:e})=>{let t=b(e).getByRole(`textbox`,{name:`Website`});await g(t).toHaveAccessibleDescription(`Include the protocol. Shown on your public profile.`),await g(t).toHaveAttribute(`data-size`,`lg`),await g(t).toHaveClass(`max-w-xs`)}},O=({inputProps:e,errors:t,children:n})=>{let r=(0,m.use)(u),i=(0,m.use)(o);return(0,h.jsx)(u,{value:{...r,...e},children:(0,h.jsx)(o,{value:i&&{...i,errors:t},children:n})})},k=_(),A=()=>{let[e,t]=(0,m.useState)(``),[n,r]=(0,m.useState)(!1),a=n&&!e?[{message:`Required`}]:void 0;return(0,h.jsx)(f,{invalid:!!a,required:!0,children:(0,h.jsxs)(O,{inputProps:{name:`email`,value:e,onChange:e=>t(e.target.value),onBlur:()=>r(!0)},errors:a,children:[(0,h.jsx)(i,{children:`Email`}),(0,h.jsx)(d,{type:`email`,onChange:k}),(0,h.jsx)(s.Error,{})]})})},j={render:()=>(0,h.jsx)(A,{}),play:async({canvasElement:e})=>{let t=b(e),n=t.getByRole(`textbox`,{name:`Email`});await g(n).toHaveAttribute(`name`,`email`),await g(t.queryByRole(`alert`)).toBeNull(),await v.click(n),await v.tab(),await g(await t.findByRole(`alert`)).toHaveTextContent(`Required`),await g(n).toHaveAttribute(`aria-invalid`,`true`),await v.type(n,`jane@example.com`),await g(n).toHaveValue(`jane@example.com`),await g(k).toHaveBeenCalled(),await y(()=>g(t.queryByRole(`alert`)).toBeNull())}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
