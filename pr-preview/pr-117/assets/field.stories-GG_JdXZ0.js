import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{D as n}from"./iframe-CKNXyHrJ.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{c as i,i as a,n as o,o as s,r as c,s as l,t as u}from"./input-CMsSYjjP.js";import{r as d}from"./input-DtS4c1yf.js";var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R;e((()=>{f=t(n(),1),c(),u(),l(),p=r(),{expect:m,userEvent:h,waitFor:g,within:_}=__STORYBOOK_MODULE_TEST__,v={title:`Components/Field`,component:o.Root,tags:[`autodocs`],argTypes:{orientation:{control:`radio`,options:[`vertical`,`horizontal`,`responsive`]},invalid:{control:`boolean`},disabled:{control:`boolean`},readOnly:{control:`boolean`},required:{control:`boolean`}},args:{orientation:`vertical`,invalid:!1,disabled:!1,readOnly:!1,required:!1},parameters:{docs:{description:{component:"Field lays out a single form field — label, control, helper text and error —\nand wires the accessibility relationships between them. `Field.Root`\ngenerates the ids and shares them through context: `Label` reads\n`LabelContext`, `Field.Description` and `Field.Error` read `FieldContext`,\nand a `Field<X>` such as `FieldText` provides the control's context. Nobody\npasses an `id` by hand.\n\nPresentational and form-library agnostic: pass `invalid` and the error\nmessages from whatever validates the form. Spacing between fields belongs to\n`Field.Group`, never to a margin on the field itself.\n\n`Field.Description` and `Field.Error` register themselves with the root, so\nthe control's `aria-describedby` lists exactly the messages on screen and is\nabsent when there is none."}}}},y=e=>{let t=s();return(0,p.jsx)(`input`,{id:t?.controlId,"aria-describedby":t?.describedBy,"aria-invalid":t?.invalid||void 0,required:t?.required||void 0,disabled:t?.disabled||void 0,readOnly:t?.readOnly||void 0,className:d(),...e})},b={render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsx)(y,{placeholder:`you@example.com`}),(0,p.jsx)(o.Description,{children:`We only use this to send policy documents.`})]}),play:async({canvasElement:e})=>{let t=_(e),n=t.getByRole(`textbox`,{name:`Email`}),r=t.getByText(/policy documents/);await m(n).toHaveAttribute(`aria-describedby`,m.stringContaining(r.id)),await m(n).toHaveAccessibleDescription(`We only use this to send policy documents.`),await m(n).not.toHaveAttribute(`aria-invalid`)}},x={args:{required:!0},render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Full name`}),(0,p.jsx)(y,{placeholder:`Jane Doe`})]}),play:async({canvasElement:e})=>{let t=_(e);await m(t.getByRole(`textbox`,{name:`Full name`})).toBeRequired(),await m(t.getByText(`*`)).toHaveAttribute(`aria-hidden`,`true`)}},S={render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{optional:!0,children:`Phone number`}),(0,p.jsx)(y,{type:`tel`,placeholder:`+1 (555) 000-0000`})]}),play:async({canvasElement:e})=>{let t=_(e);await m(t.getByText(`Phone number`)).toHaveClass(/after:content/),await m(t.getByRole(`textbox`,{name:`Phone number`})).not.toBeRequired()}},C={args:{required:!0},render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(o.Label,{tooltip:`Issued by the IRS to identify your business.`,children:`Tax ID`}),(0,p.jsx)(y,{placeholder:`XX-XXXXXXX`})]}),play:async({canvasElement:e})=>{let t=_(e),n=t.getByRole(`button`,{name:`More information`});await m(n.closest(`label`)).toBeNull(),await m(t.getByRole(`textbox`,{name:`Tax ID`})).toBeInTheDocument(),await h.tab(),await m(n).toHaveFocus(),await m((await _(document.body).findAllByText(/Issued by the IRS/)).length).toBeGreaterThan(0)}},w={args:{invalid:!0},render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsx)(y,{type:`email`,defaultValue:`not-an-email`}),(0,p.jsx)(o.Error,{errors:[{message:`Enter a valid email address.`}]})]}),play:async({canvasElement:e})=>{let t=_(e),n=t.getByRole(`textbox`,{name:`Email`}),r=t.getByRole(`alert`);await m(n).toHaveAttribute(`aria-invalid`,`true`),await m(n).toHaveAttribute(`aria-describedby`,m.stringContaining(r.id)),await m(n).toHaveAccessibleDescription(`Enter a valid email address.`),await m(e.querySelector(`[data-slot=field][data-invalid="true"]`)).not.toBeNull()}},T={args:{invalid:!0},render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Password`}),(0,p.jsx)(y,{type:`password`,defaultValue:`abc`}),(0,p.jsx)(o.Error,{errors:[{message:`Use at least 8 characters.`},{message:`Include a number.`},{message:`Use at least 8 characters.`}]})]}),play:async({canvasElement:e})=>{let t=_(e);await m(t.getByRole(`alert`)).toBeInTheDocument(),await m(t.getAllByRole(`listitem`)).toHaveLength(2)}},E={args:{invalid:!0},render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Password`}),(0,p.jsx)(y,{type:`password`,defaultValue:`short`}),(0,p.jsx)(o.Error,{errors:[{message:`At least one uppercase letter.`,types:{uppercase:`At least one uppercase letter.`,number:`At least one number.`,length:[`At least 10 characters.`],unnamed:!0}}]})]}),play:async({canvasElement:e})=>{let t=_(e).getByRole(`alert`),n=_(t).getAllByRole(`listitem`);await m(n).toHaveLength(3),await m(n[0]).toHaveTextContent(`At least one uppercase letter.`),await m(n[1]).toHaveTextContent(`At least one number.`),await m(n[2]).toHaveTextContent(`At least 10 characters.`),await m(t).not.toHaveTextContent(`true`)}},D={render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsx)(y,{type:`email`}),(0,p.jsx)(o.Error,{errors:[void 0]})]}),play:async({canvasElement:e})=>{let t=_(e);await m(t.queryByRole(`alert`)).toBeNull(),await m(t.getByRole(`textbox`,{name:`Email`})).not.toHaveAttribute(`aria-describedby`)}},O={args:{disabled:!0},render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Agency`}),(0,p.jsx)(y,{defaultValue:`Acme Insurance`}),(0,p.jsx)(o.Description,{children:`Managed by your administrator.`})]}),play:async({canvasElement:e})=>{await m(_(e).getByRole(`textbox`,{name:`Agency`})).toBeDisabled(),await m(e.querySelector(`[data-slot=field][data-disabled]`)).not.toBeNull()}},k={args:{readOnly:!0},render:e=>(0,p.jsxs)(o.Root,{...e,children:[(0,p.jsx)(i,{children:`Policy number`}),(0,p.jsx)(y,{defaultValue:`POL-2049-118`}),(0,p.jsx)(o.Description,{children:`Assigned by the carrier; contact support to change it.`})]}),play:async({canvasElement:e})=>{let t=_(e).getByRole(`textbox`,{name:`Policy number`});await m(t).toHaveAttribute(`readonly`),await m(t).not.toBeDisabled(),await m(e.querySelector(`[data-slot=field][data-readonly]`)).not.toBeNull()}},A={render:()=>(0,p.jsxs)(o.Group,{className:`w-[40rem]`,children:[(0,p.jsxs)(o.Root,{orientation:`horizontal`,"data-testid":`short`,children:[(0,p.jsx)(i,{children:`Full name`}),(0,p.jsx)(y,{defaultValue:`Rafa Moro`,className:`w-72`})]}),(0,p.jsxs)(o.Root,{orientation:`horizontal`,"data-testid":`long`,children:[(0,p.jsx)(i,{children:`Title`}),(0,p.jsxs)(o.Content,{className:`w-72`,children:[(0,p.jsx)(y,{placeholder:`Software engineer`}),(0,p.jsx)(o.Description,{children:`Shown on your public profile.`})]})]}),(0,p.jsxs)(o.Root,{orientation:`horizontal`,"data-testid":`switch`,children:[(0,p.jsxs)(o.Content,{children:[(0,p.jsx)(i,{children:`Auto-renew`}),(0,p.jsx)(o.Description,{children:`Renews the policy automatically before it expires.`})]}),(0,p.jsx)(y,{type:`checkbox`,className:`size-5`})]}),(0,p.jsx)(`div`,{className:`w-[20rem]`,"data-testid":`narrow`,children:(0,p.jsxs)(o.Root,{orientation:`horizontal`,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsx)(y,{type:`email`,placeholder:`you@example.com`,className:`w-40`})]})})]}),play:async({canvasElement:e})=>{let t=_(e),n=e=>e.getBoundingClientRect(),r=t.getByTestId(`short`),i=t.getByTestId(`long`),a=r.querySelector(`input`),o=i.querySelector(`input`);await m(n(a).left).toBe(n(o).left),await m(Math.round(n(a).right)).toBe(Math.round(n(r).right));let s=i.querySelector(`[data-slot=field-description]`);await m(n(s).left).toBe(n(o).left),await m(n(s).top).toBeGreaterThanOrEqual(n(o).bottom),await m(o).toHaveAccessibleDescription(`Shown on your public profile.`);let c=t.getByTestId(`switch`).querySelector(`input`);await m(Math.round(n(c).right)).toBe(Math.round(n(t.getByTestId(`switch`)).right));let l=t.getByTestId(`narrow`),u=l.querySelector(`label`),d=l.querySelector(`input`);await m(n(u).right).toBeLessThanOrEqual(n(d).left)}},j={render:()=>(0,p.jsxs)(`div`,{className:`flex flex-col gap-8`,children:[(0,p.jsx)(`div`,{className:`w-full max-w-[40rem]`,"data-testid":`wide`,children:(0,p.jsxs)(o.Root,{orientation:`responsive`,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsxs)(o.Content,{className:`@md/field:w-72`,children:[(0,p.jsx)(y,{type:`email`,placeholder:`you@example.com`}),(0,p.jsx)(o.Description,{children:`We only use this to send policy documents, and never to contact you about anything else.`})]})]})}),(0,p.jsx)(`div`,{className:`w-full max-w-[20rem]`,"data-testid":`narrow`,children:(0,p.jsxs)(o.Root,{orientation:`responsive`,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsxs)(o.Content,{children:[(0,p.jsx)(y,{type:`email`,placeholder:`you@example.com`}),(0,p.jsx)(o.Description,{children:`We only use this to send policy documents.`})]})]})})]}),play:async({canvasElement:e})=>{let t=_(e),n=e=>e.getBoundingClientRect(),r=t.getByTestId(`wide`),i=r.querySelector(`label`),a=r.querySelector(`input`),o=r.querySelector(`[data-slot=field-content]`);await m(n(i).right).toBeLessThanOrEqual(n(a).left),await m(n(o).width).toBe(288);let s=t.getByTestId(`narrow`),c=s.querySelector(`label`),l=s.querySelector(`input`);await m(n(l).top).toBeGreaterThanOrEqual(n(c).bottom),await m(n(l).left).toBe(n(c).left)}},M={render:()=>(0,p.jsxs)(o.Group,{children:[(0,p.jsxs)(o.Root,{required:!0,children:[(0,p.jsx)(i,{children:`Full name`}),(0,p.jsx)(y,{placeholder:`Jane Doe`})]}),(0,p.jsxs)(o.Root,{required:!0,invalid:!0,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsx)(y,{type:`email`,defaultValue:`not-an-email`}),(0,p.jsx)(o.Error,{children:`Enter a valid email address.`})]}),(0,p.jsxs)(o.Root,{children:[(0,p.jsx)(i,{optional:!0,children:`Phone number`}),(0,p.jsx)(y,{type:`tel`,placeholder:`+1 (555) 000-0000`})]})]}),play:async({canvasElement:e})=>{let t=_(e),n=t.getAllByRole(`textbox`).map(e=>e.id);await m(new Set(n).size).toBe(3),await m(t.getAllByRole(`alert`)).toHaveLength(1)}},N={render:()=>(0,p.jsxs)(`div`,{className:`flex flex-col gap-2`,children:[(0,p.jsx)(i,{htmlFor:`standalone-email`,children:`Email`}),(0,p.jsx)(y,{id:`standalone-email`,type:`email`,"aria-describedby":`standalone-error`}),(0,p.jsx)(o.Error,{id:`standalone-error`,children:`Something went wrong.`})]}),play:async({canvasElement:e})=>{let t=_(e);await m(t.getByRole(`textbox`,{name:`Email`})).toHaveAttribute(`id`,`standalone-email`),await m(t.getByRole(`alert`)).toHaveAttribute(`id`,`standalone-error`)}},P={render:()=>(0,p.jsxs)(o.Root,{children:[(0,p.jsx)(i,{htmlFor:`own-input`,children:`Email`}),(0,p.jsx)(`input`,{id:`own-input`,type:`email`,className:d()}),(0,p.jsx)(o.Description,{id:`own-description`,children:`Points wherever you say.`})]}),play:async({canvasElement:e})=>{let t=_(e);await m(t.getByText(`Email`).closest(`label`)).toHaveAttribute(`for`,`own-input`),await m(t.getByRole(`textbox`,{name:`Email`})).toHaveAttribute(`id`,`own-input`),await m(t.getByText(/Points wherever/)).toHaveAttribute(`id`,`own-description`)}},F=({errors:e,children:t})=>{let n=(0,f.use)(a);return(0,p.jsx)(a,{value:n&&{...n,errors:e},children:t})},I=()=>{let[e,t]=(0,f.useState)(``),[n,r]=(0,f.useState)(!1),a=n&&!e?[{message:`Required`}]:void 0;return(0,p.jsxs)(o.Root,{invalid:!!a,required:!0,children:[(0,p.jsx)(i,{children:`Email`}),(0,p.jsx)(y,{type:`email`,value:e,onChange:e=>t(e.target.value),onBlur:()=>r(!0)}),(0,p.jsx)(F,{errors:a,children:(0,p.jsx)(o.Error,{})})]})},L={render:()=>(0,p.jsx)(I,{}),play:async({canvasElement:e})=>{let t=_(e),n=t.getByRole(`textbox`,{name:`Email`});await m(t.queryByRole(`alert`)).toBeNull(),await h.click(n),await h.tab(),await m(await t.findByRole(`alert`)).toHaveTextContent(`Required`),await m(n).toHaveAttribute(`aria-invalid`,`true`),await h.type(n,`jane@example.com`),await g(()=>m(t.queryByRole(`alert`)).toBeNull()),await m(n).not.toHaveAttribute(`aria-invalid`)}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
