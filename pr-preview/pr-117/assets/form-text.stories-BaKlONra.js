import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{t as n}from"./button-C3UW4GUV.js";import{t as r}from"./button-BmsNcWFj.js";import{n as i,r as a}from"./input-DyK9waP9.js";import{i as o,n as s,o as c,r as l,s as u,t as d}from"./form-CcQqwJEw.js";var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{c(),l(),r(),a(),s(),f=t(),{expect:p,fn:m,userEvent:h,waitFor:g,within:_}=__STORYBOOK_MODULE_TEST__,v={title:`Components/FormText`,component:o,tags:[`autodocs`],argTypes:{orientation:{control:`radio`,options:[`vertical`,`horizontal`,`responsive`]},label:{control:`text`},description:{control:`text`},tooltip:{control:`text`},required:{control:`boolean`},optional:{control:`boolean`},disabled:{control:`boolean`},readOnly:{control:`boolean`}},parameters:{docs:{description:{component:"FormText is a complete text field bound to one react-hook-form value: label,\n`Input`, helper text and validation error in the standard order, wired\nthrough `useController`. It renders inside a `Form.Root` and needs only a\n`name`; `required`, `invalid` and the error reach the label, the input's\n`aria-*` attributes and the message with no ids written by hand.\n\nIt covers the common case. For another layout — an input with addons, a\ndifferent control, a message rendered elsewhere — compose `useController`\nwith the `FieldText`, `Label`, `Input` and `Field.*` primitives directly."}}}},y=m(),b=()=>{let e=u({defaultValues:{agencyName:``}});return(0,f.jsxs)(d.Root,{methods:e,onSubmit:y,"aria-label":`Agency`,className:`flex flex-col items-start gap-7`,children:[(0,f.jsx)(o,{name:`agencyName`,label:`Agency name`,required:!0,rules:{required:`Enter the agency name.`},inputProps:{placeholder:`Acme Insurance`}}),(0,f.jsx)(n,{type:`submit`,children:`Save`})]})},x={parameters:{docs:{source:{code:`const methods = useForm<AgencyValues>({ defaultValues: { agencyName: '' } });
