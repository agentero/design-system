...
}`,...$.parameters?.docs?.source},description:{story:"`openDelay` / `closeDelay` tune the hover latency. Default is a deliberate\n`700ms` open so cards don't flash on incidental passes; drop it to `0` for\ntrigger-dense UIs where an instant preview reads as more responsive.",...$.parameters?.docs?.description}}},Me=[`Default`,`AbandonedHover`,`OpensOnFocus`,`Sides`,`RichContent`,`WithArrow`,`Delays`]}))();export{J as AbandonedHover,q as Default,$ as Delays,Y as OpensOnFocus,Z as RichContent,X as Sides,Q as WithArrow,Me as __namedExportsOrder,je as default};