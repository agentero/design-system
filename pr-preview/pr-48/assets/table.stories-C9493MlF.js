...
}`,...w.parameters?.docs?.source},description:{story:"`Table.ExpandButton` toggles a `Table.ExpandedRow` detail panel under its row.\n\n@summary Expandable rows with a detail panel",...w.parameters?.docs?.description}}},T=[`Default`,`Sizes`,`StickyHeader`,`StickyHeaderAndFooter`,`Embed`,`WithCheckbox`,`WithRowActions`,`ExpandableRows`]}))();export{_ as Default,x as Embed,w as ExpandableRows,v as Sizes,y as StickyHeader,b as StickyHeaderAndFooter,S as WithCheckbox,C as WithRowActions,T as __namedExportsOrder,g as default};