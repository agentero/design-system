import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{D as n}from"./iframe-CMHgnD1r.js";import{t as r}from"./react-dom-BsSjXbOU.js";import{t as i}from"./jsx-runtime-CaZkqeYb.js";import{n as a,t as o}from"./dist-xs6gOf1u.js";import{n as s,t as c}from"./lib-Dkaf_tmd.js";import{n as l,t as u}from"./label-3mP8KjaP.js";var d=e((()=>{l()}));function f(e,t){if(typeof e==`function`)return e(t);e!=null&&(e.current=t)}function p(...e){return t=>{let n=!1,r=e.map(e=>{let r=f(e,t);return!n&&typeof r==`function`&&(n=!0),r});if(n)return()=>{for(let t=0;t<r.length;t++){let n=r[t];typeof n==`function`?n():f(e[t],null)}}}}function m(...e){return h.useCallback(p(...e),e)}var h,ee,g,_=e((()=>{h=t(n(),1),ee=Object.defineProperty,g=(e,t)=>ee(e,`name`,{value:t,configurable:!0}),g(f,`setRef`),g(p,`composeRefs`),g(m,`useComposedRefs`)}));function v(e,t){let n=x.createContext(t);n.displayName=e+`Context`;let r=S(e=>{let{children:t,...r}=e,i=x.useMemo(()=>r,Object.values(r));return(0,te.jsx)(n.Provider,{value:i,children:t})},`Provider`);r.displayName=e+`Provider`;function i(r,i={}){let{optional:a=!1}=i,o=x.useContext(n);if(o)return o;if(t!==void 0)return t;if(!a)throw Error(`\`${r}\` must be used within \`${e}\``)}return S(i,`useContext`),[r,i]}function y(e,t=[]){let n=[];function r(t,r){let i=x.createContext(r);i.displayName=t+`Context`;let a=n.length;n=[...n,r];let o=S(t=>{let{scope:n,children:r,...o}=t,s=n?.[e]?.[a]||i,c=x.useMemo(()=>o,Object.values(o));return(0,te.jsx)(s.Provider,{value:c,children:r})},`Provider`);o.displayName=t+`Provider`;function s(n,o,s={}){let{optional:c=!1}=s,l=o?.[e]?.[a]||i,u=x.useContext(l);if(u)return u;if(r!==void 0)return r;if(!c)throw Error(`\`${n}\` must be used within \`${t}\``)}return S(s,`useContext`),[o,s]}S(r,`createContext`);let i=S(()=>{let t=n.map(e=>x.createContext(e));return S(function(n){let r=n?.[e]||t;return x.useMemo(()=>({[`__scope${e}`]:{...n,[e]:r}}),[n,r])},`useScope`)},`createScope`);return i.scopeName=e,[r,b(i,...t)]}function b(...e){let t=e[0];if(e.length===1)return t;let n=S(()=>{let n=e.map(e=>({useScope:e(),scopeName:e.scopeName}));return S(function(e){let r=n.reduce((t,{useScope:n,scopeName:r})=>{let i=n(e)[`__scope${r}`];return{...t,...i}},{});return x.useMemo(()=>({[`__scope${t.scopeName}`]:r}),[r])},`useComposedScopes`)},`createScope`);return n.scopeName=t.scopeName,n}var x,te,ne,S,re=e((()=>{x=t(n(),1),te=i(),ne=Object.defineProperty,S=(e,t)=>ne(e,`name`,{value:t,configurable:!0}),S(v,`createContext`),S(y,`createContextScope`),S(b,`composeContextScopes`)}));function ie(e,t,{checkForDefaultPrevented:n=!0}={}){return C(function(r){if(e?.(r),n===!1||!r||!r.defaultPrevented)return t?.(r)},`handleEvent`)}function ae(e){if(!ue)throw Error(`Cannot access window outside of the DOM`);return e?.ownerDocument?.defaultView??window}function oe(e){if(!ue)throw Error(`Cannot access document outside of the DOM`);return e?.ownerDocument??document}function se(e,t=!1){let{activeElement:n}=oe(e);if(!n?.nodeName)return null;if(ce(n)&&n.contentDocument)return se(n.contentDocument.body,t);if(t){let e=n.getAttribute(`aria-activedescendant`);if(e){let t=oe(n).getElementById(e);if(t)return t}}return n}function ce(e){return e.tagName===`IFRAME`}var le,C,ue,de=e((()=>{le=Object.defineProperty,C=(e,t)=>le(e,`name`,{value:t,configurable:!0}),ue=!!(typeof window<`u`&&window.document&&window.document.createElement),C(ie,`composeEventHandlers`),C(ae,`getOwnerWindow`),C(oe,`getOwnerDocument`),C(se,`getActiveElement`),C(ce,`isFrame`)})),fe=e((()=>{})),pe,w,me=e((()=>{pe=t(n(),1),w=globalThis?.document?pe.useLayoutEffect:()=>{}}));function he(e){if(typeof ye==`function`)return ye(e);let t=ge.useRef(()=>{throw Error(`Cannot call an event handler while rendering.`)});return typeof be==`function`?be(()=>{t.current=e}):w(()=>{t.current=e}),ge.useMemo(()=>((...e)=>t.current?.(...e)),[])}var ge,_e,ve,ye,be,xe=e((()=>{me(),ge=t(n(),1),_e=Object.defineProperty,ve=(e,t)=>_e(e,`name`,{value:t,configurable:!0}),ye=ge.useEffectEvent,be=ge.useInsertionEffect,ve(he,`useEffectEvent`)}));function Se({prop:e,defaultProp:t,onChange:n=D(()=>{},`onChange`),caller:r}){let[i,a,o]=Ce({defaultProp:t,onChange:n}),s=e!==void 0;return[s?e:i,T.useCallback(t=>{if(s){let n=we(t)?t(e):t;n!==e&&o.current?.(n)}else a(t)},[s,e,a,o])]}function Ce({defaultProp:e,onChange:t}){let[n,r]=T.useState(e),i=T.useRef(n),a=T.useRef(t);return De(()=>{a.current=t},[t]),T.useEffect(()=>{i.current!==n&&(a.current?.(n),i.current=n)},[n,i]),[n,r,a]}function we(e){return typeof e==`function`}function Te(e,t,n,r){let{prop:i,defaultProp:a,onChange:o,caller:s}=t,c=i!==void 0,l=he(o),u=[{...n,state:a}];r&&u.push(r);let[d,f]=E.useReducer((t,n)=>{if(n.type===Oe)return{...t,state:n.state};let r=e(t,n);return c&&!Object.is(r.state,t.state)&&l(r.state),r},...u),p=d.state,m=E.useRef(p);E.useEffect(()=>{m.current!==p&&(m.current=p,c||l(p))},[p,m,c]);let h=E.useMemo(()=>i===void 0?d:{...d,state:i},[d,i]);return E.useEffect(()=>{c&&!Object.is(i,d.state)&&f({type:Oe,state:i})},[i,d.state,c]),[h,f]}var T,E,Ee,D,De,Oe,ke=e((()=>{T=t(n(),1),fe(),me(),E=t(n(),1),xe(),Ee=Object.defineProperty,D=(e,t)=>Ee(e,`name`,{value:t,configurable:!0}),De=T.useInsertionEffect||w,D(Se,`useControllableState`),D(Ce,`useUncontrolledState`),D(we,`isFunction`),Oe=Symbol(`RADIX:SYNC_STATE`),D(Te,`useControllableStateReducer`)}));function Ae(e){let[t,n]=je.useState(void 0);return w(()=>{if(e){n({width:e.offsetWidth,height:e.offsetHeight});let t=new ResizeObserver(t=>{if(!Array.isArray(t)||!t.length)return;let r=t[0],i,a;if(`borderBoxSize`in r){let e=r.borderBoxSize,t=Array.isArray(e)?e[0]:e;i=t.inlineSize,a=t.blockSize}else i=e.offsetWidth,a=e.offsetHeight;n({width:i,height:a})});return t.observe(e,{box:`border-box`}),()=>t.unobserve(e)}else n(void 0)},[e]),t}var je,Me,Ne,Pe=e((()=>{je=t(n(),1),me(),Me=Object.defineProperty,Ne=(e,t)=>Me(e,`name`,{value:t,configurable:!0}),Ne(Ae,`useSize`)}));function Fe(e,t){return Be.useReducer((e,n)=>t[e][n]??e,e)}function Ie(e){let[t,n]=k.useState(),r=k.useRef(null),i=k.useRef(e),a=k.useRef(`none`),o=k.useRef(void 0),[s,c]=Fe(e?`mounted`:`unmounted`,{mounted:{UNMOUNT:`unmounted`,ANIMATION_OUT:`unmountSuspended`},unmountSuspended:{MOUNT:`mounted`,ANIMATION_END:`unmounted`},unmounted:{MOUNT:`mounted`}});return k.useEffect(()=>{s===`mounted`?(a.current=o.current??O(r.current),o.current=void 0):a.current=`none`},[s]),w(()=>{let t=r.current,n=i.current;if(n!==e){let r=a.current,s=O(t);e?(o.current=s,c(`MOUNT`)):s===`none`||t?.display===`none`?c(`UNMOUNT`):c(n&&r!==s?`ANIMATION_OUT`:`UNMOUNT`),i.current=e}},[e,c]),w(()=>{if(t){let e,n=t.ownerDocument.defaultView??window,o=A(a=>{let o=O(r.current).includes(CSS.escape(a.animationName));if(a.target===t&&o&&(c(`ANIMATION_END`),!i.current)){let r=t.style.animationFillMode;t.style.animationFillMode=`forwards`,e=n.setTimeout(()=>{t.style.animationFillMode===`forwards`&&(t.style.animationFillMode=r)})}},`handleAnimationEnd`),s=A(e=>{e.target===t&&(a.current=O(r.current))},`handleAnimationStart`);return t.addEventListener(`animationstart`,s),t.addEventListener(`animationcancel`,o),t.addEventListener(`animationend`,o),()=>{n.clearTimeout(e),t.removeEventListener(`animationstart`,s),t.removeEventListener(`animationcancel`,o),t.removeEventListener(`animationend`,o)}}else c(`ANIMATION_END`)},[t,c]),{isPresent:[`mounted`,`unmountSuspended`].includes(s),ref:k.useCallback(e=>{if(e){let t=getComputedStyle(e);r.current=t,o.current=O(t)}else r.current=null;n(e)},[])}}function Le(e,t){if(typeof e==`function`)return e(t);e!=null&&(e.current=t)}function Re(...e){let t=k.useRef(e);return t.current=e,k.useCallback(e=>{let n=t.current,r=!1,i=n.map(t=>{let n=Le(t,e);return!r&&typeof n==`function`&&(r=!0),n});if(r)return()=>{for(let e=0;e<i.length;e++){let t=i[e];typeof t==`function`?t():Le(n[e],null)}}},[])}function O(e){return e?.animationName||`none`}function ze(e){let t=Object.getOwnPropertyDescriptor(e.props,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning;return n?e.ref:(t=Object.getOwnPropertyDescriptor(e,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}var k,Be,Ve,A,He,Ue=e((()=>{k=t(n(),1),me(),Be=t(n(),1),Ve=Object.defineProperty,A=(e,t)=>Ve(e,`name`,{value:t,configurable:!0}),A(Fe,`useStateMachine`),He=A(e=>{let{present:t,children:n}=e,r=Ie(t),i=typeof n==`function`?n({present:r.isPresent}):k.Children.only(n),a=Re(r.ref,ze(i));return typeof n==`function`||r.isPresent?k.cloneElement(i,{ref:a}):null},`Presence`),A(Ie,`usePresence`),A(Le,`setRef`),A(Re,`useStableComposedRefs`),A(O,`getAnimationName`),A(ze,`getElementRef`)}));function We(e){let t=j.forwardRef((t,n)=>{let{children:r,...i}=t,a=null,o=!1,s=[];Ye(r)&&typeof N==`function`&&(r=N(r._payload)),j.Children.forEach(r,e=>{if(Je(e)){o=!0;let t=e,n=`child`in t.props?t.props.child:t.props.children;Ye(n)&&typeof N==`function`&&(n=N(n._payload)),a=$e(t,n),s.push(a?.props?.children)}else s.push(e)}),a?a=j.cloneElement(a,void 0,s):!o&&j.Children.count(r)===1&&j.isValidElement(r)&&(a=r);let c=a?qe(a):void 0,l=m(n,c);if(!a){if(r||r===0)throw Error(o?nt(e):tt(e));return r}let u=Ke(i,a.props??{});return a.type!==j.Fragment&&(u.ref=n?l:c),j.cloneElement(a,u)});return t.displayName=`${e}.Slot`,t}function Ge(e){let t=M(e=>`child`in e?e.children(e.child):e.children,`Slottable`);return t.displayName=`${e}.Slottable`,t.__radixId=Qe,t}function Ke(e,t){let n={...t};for(let r in t){let i=e[r],a=t[r];/^on[A-Z]/.test(r)?i&&a?n[r]=(...e)=>{let t=a(...e);return i(...e),t}:i&&(n[r]=i):r===`style`?n[r]={...i,...a}:r===`className`&&(n[r]=[i,a].filter(Boolean).join(` `))}return{...e,...n}}function qe(e){let t=Object.getOwnPropertyDescriptor(e.props,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning;return n?e.ref:(t=Object.getOwnPropertyDescriptor(e,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}function Je(e){return j.isValidElement(e)&&typeof e.type==`function`&&`__radixId`in e.type&&e.type.__radixId===Qe}function Ye(e){return typeof e==`object`&&!!e&&`$$typeof`in e&&e.$$typeof===et&&`_payload`in e&&Xe(e._payload)}function Xe(e){return typeof e==`object`&&!!e&&`then`in e}var j,Ze,M,Qe,$e,et,tt,nt,N,rt=e((()=>{j=t(n(),1),_(),Ze=Object.defineProperty,M=(e,t)=>Ze(e,`name`,{value:t,configurable:!0}),M(We,`createSlot`),Qe=Symbol.for(`radix.slottable`),M(Ge,`createSlottable`),$e=M((e,t)=>{if(`child`in e.props){let t=e.props.child;return j.isValidElement(t)?j.cloneElement(t,void 0,e.props.children(t.props.children)):null}return j.isValidElement(t)?t:null},`getSlottableElementFromSlottable`),M(Ke,`mergeProps`),M(qe,`getElementRef`),M(Je,`isSlottable`),et=Symbol.for(`react.lazy`),M(Ye,`isLazyComponent`),M(Xe,`isPromiseLike`),tt=M(e=>`${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`,`createSlotError`),nt=M(e=>`${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`,`createSlottableError`),N=j.use}));function it(e,t){e&&ot.flushSync(()=>e.dispatchEvent(t))}var at,ot,st,ct,lt,ut,dt=e((()=>{at=t(n(),1),ot=t(r(),1),rt(),st=i(),ct=Object.defineProperty,lt=(e,t)=>ct(e,`name`,{value:t,configurable:!0}),ut=[`a`,`button`,`div`,`form`,`h2`,`h3`,`img`,`input`,`label`,`li`,`nav`,`ol`,`p`,`select`,`span`,`svg`,`ul`].reduce((e,t)=>{let n=We(`Primitive.${t}`),r=at.forwardRef((e,r)=>{let{asChild:i,...a}=e,o=i?n:t;return typeof window<`u`&&(window[Symbol.for(`radix-ui`)]=!0),(0,st.jsx)(o,{...a,ref:r})});return r.displayName=`Primitive.${t}`,{...e,[t]:r}},{}),lt(it,`dispatchDiscreteCustomEvent`)}));function ft(e){let{__scopeCheckbox:t,checked:n,children:r,defaultChecked:i,disabled:a,form:o,name:s,onCheckedChange:c,required:l,value:u=`on`,internal_do_not_use_render:d}=e,[f,p]=Se({prop:n,defaultProp:i??!1,onChange:c,caller:gt}),[m,h]=F.useState(null),[ee,g]=F.useState(null),_=F.useRef(!1),[v,y]=F.useReducer(e=>e+1,0),b=m?!!o||!!m.closest(`form`):!0,x={checked:f,disabled:a,setChecked:p,control:m,setControl:h,name:s,form:o,value:u,hasConsumerStoppedPropagationRef:_,userInteractionCount:v,onUserInteraction:y,required:l,defaultChecked:P(i)?!1:i,isFormControl:b,bubbleInput:ee,setBubbleInput:g};return(0,I.jsx)(yt,{scope:t,...x,children:pt(d)?d(x):r})}function pt(e){return typeof e==`function`}function P(e){return e===`indeterminate`}function mt(e){return P(e)?`indeterminate`:e?`checked`:`unchecked`}var F,I,ht,L,gt,_t,vt,yt,bt,xt,St,Ct,wt,Tt,Et,Dt,Ot=e((()=>{F=t(n(),1),_(),re(),de(),ke(),Pe(),Ue(),dt(),I=i(),ht=Object.defineProperty,L=(e,t)=>ht(e,`name`,{value:t,configurable:!0}),gt=`Checkbox`,[_t,vt]=y(gt),[yt,bt]=_t(gt),L(ft,`CheckboxProvider`),xt=`CheckboxTrigger`,St=F.forwardRef(L(function({__scopeCheckbox:e,onKeyDown:t,onClick:n,...r},i){let{control:a,value:o,disabled:s,checked:c,required:l,setControl:u,setChecked:d,hasConsumerStoppedPropagationRef:f,onUserInteraction:p,isFormControl:h,bubbleInput:ee}=bt(xt,e),g=m(i,u),_=F.useRef(c);return F.useEffect(()=>{let e=a?.form;if(e){let t=L(()=>d(_.current),`reset`);return e.addEventListener(`reset`,t),()=>e.removeEventListener(`reset`,t)}},[a,d]),(0,I.jsx)(ut.button,{type:`button`,role:`checkbox`,"aria-checked":P(c)?`mixed`:c,"aria-required":l,"data-state":mt(c),"data-disabled":s?``:void 0,disabled:s,value:o,...r,ref:g,onKeyDown:ie(t,e=>{e.key===`Enter`&&e.preventDefault()}),onClick:ie(n,e=>{p(),d(e=>P(e)?!0:!e),ee&&h&&(f.current=e.isPropagationStopped(),f.current||e.stopPropagation())})})},`CheckboxTrigger`)),Ct=F.forwardRef(L(function(e,t){let{__scopeCheckbox:n,name:r,checked:i,defaultChecked:a,required:o,disabled:s,value:c,onCheckedChange:l,form:u,...d}=e;return(0,I.jsx)(ft,{__scopeCheckbox:n,checked:i,defaultChecked:a,disabled:s,required:o,onCheckedChange:l,name:r,form:u,value:c,internal_do_not_use_render:({isFormControl:e})=>(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(St,{...d,ref:t,__scopeCheckbox:n}),e&&(0,I.jsx)(Dt,{__scopeCheckbox:n})]})})},`Checkbox`)),wt=`CheckboxIndicator`,Tt=F.forwardRef(L(function(e,t){let{__scopeCheckbox:n,forceMount:r,...i}=e,a=bt(wt,n);return(0,I.jsx)(He,{present:r||P(a.checked)||a.checked===!0,children:(0,I.jsx)(ut.span,{"data-state":mt(a.checked),"data-disabled":a.disabled?``:void 0,...i,ref:t,style:{pointerEvents:`none`,...e.style}})})},`CheckboxIndicator`)),Et=`CheckboxBubbleInput`,Dt=F.forwardRef(L(function({__scopeCheckbox:e,onClick:t,...n},r){let{control:i,hasConsumerStoppedPropagationRef:a,userInteractionCount:o,checked:s,defaultChecked:c,required:l,disabled:u,name:d,value:f,form:p,bubbleInput:h,setBubbleInput:ee}=bt(Et,e),g=m(r,ee),_=Ae(i),v=F.useRef(!1),y=F.useRef(s),b=F.useRef(o);F.useEffect(()=>{let e=h;if(!e)return;let t=window.HTMLInputElement.prototype,n=Object.getOwnPropertyDescriptor(t,`checked`).set,r=o!==b.current;b.current=o;let i=y.current!==s;y.current=s;let c=!(r&&a.current);if(i&&n){v.current=!r;let t=new Event(`click`,{bubbles:c});e.indeterminate=P(s),n.call(e,P(s)?!1:s),e.dispatchEvent(t),v.current=!1}},[h,s,a,o]);let x=F.useRef(P(s)?!1:s);return(0,I.jsx)(ut.input,{type:`checkbox`,"aria-hidden":!0,defaultChecked:c??x.current,required:l,disabled:u,name:d,value:f,form:p,...n,tabIndex:-1,ref:g,onClick:ie(t,e=>{v.current&&e.stopPropagation()}),style:{...n.style,..._,position:`absolute`,pointerEvents:`none`,opacity:0,margin:0,transform:`translateX(-100%)`}})},`CheckboxBubbleInput`)),L(pt,`isFunction`),L(P,`isIndeterminate`),L(mt,`getState`)})),kt,At,jt,Mt=e((()=>{kt=i(),At=e=>(0,kt.jsx)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`currentColor`,stroke:`currentColor`,"aria-hidden":`true`,xmlns:`http://www.w3.org/2000/svg`,...e,children:(0,kt.jsx)(`path`,{d:`M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z`})}),jt=e=>(0,kt.jsx)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,"aria-hidden":`true`,xmlns:`http://www.w3.org/2000/svg`,...e,children:(0,kt.jsx)(`path`,{d:`M5 12h14`})});try{At.displayName=`IconCheck`,At.__docgenInfo={description:``,displayName:`IconCheck`,filePath:`/home/runner/work/design-system/design-system/src/checkbox/icons.tsx`,methods:[],props:{},tags:{summary:`Material Sharp check used by the legacy checkbox`}}}catch{}try{jt.displayName=`IconMinus`,jt.__docgenInfo={description:``,displayName:`IconMinus`,filePath:`/home/runner/work/design-system/design-system/src/checkbox/icons.tsx`,methods:[],props:{},tags:{summary:`Rounded minus used by the legacy checkbox's mixed state`}}}catch{}})),Nt,Pt,R,Ft=e((()=>{Ot(),o(),c(),Mt(),Nt=i(),Pt=a({slots:{root:[`group/checkbox box-border inline-flex size-4 shrink-0 appearance-none items-center justify-center rounded-sm`,`border border-solid border-border-input-default bg-bg-input-normal`,`cursor-pointer transition-colors duration-200 ease-in-out`,`data-[state=checked]:border-bg-checkbox-selected data-[state=checked]:bg-bg-checkbox-selected`,`data-[state=indeterminate]:border-bg-checkbox-selected data-[state=indeterminate]:bg-bg-checkbox-selected`,`outline-solid outline-2 outline-offset-2 outline-transparent`,`focus-visible:outline-focus-ring-button-primary`,`aria-invalid:border-border-input-destructive`,`aria-invalid:focus-visible:outline-focus-ring-button-destructive`,`aria-invalid:data-[state=checked]:border-bg-default-danger-primary aria-invalid:data-[state=checked]:bg-bg-default-danger-primary`,`aria-invalid:data-[state=indeterminate]:border-bg-default-danger-primary aria-invalid:data-[state=indeterminate]:bg-bg-default-danger-primary`,`disabled:cursor-not-allowed disabled:border-border-checkbox-disabled`,`disabled:data-[state=checked]:border-bg-checkbox-disabled disabled:data-[state=checked]:bg-bg-checkbox-disabled`,`disabled:data-[state=indeterminate]:border-bg-checkbox-disabled disabled:data-[state=indeterminate]:bg-bg-checkbox-disabled`,`aria-invalid:disabled:border-bg-checkbox-invalid-disabled`,`aria-invalid:disabled:data-[state=checked]:border-bg-checkbox-invalid-disabled aria-invalid:disabled:data-[state=checked]:bg-bg-checkbox-invalid-disabled`,`aria-invalid:disabled:data-[state=indeterminate]:border-bg-checkbox-invalid-disabled aria-invalid:disabled:data-[state=indeterminate]:bg-bg-checkbox-invalid-disabled`],indicator:`flex items-center justify-center text-text-default-base-inverse-primary`}}),R=({className:e,ref:t,...n})=>{let r=Pt();return(0,Nt.jsx)(Ct,{ref:t,"data-slot":`checkbox`,className:s(r.root(),e),...n,children:(0,Nt.jsxs)(Tt,{"data-slot":`checkbox-indicator`,className:r.indicator(),children:[(0,Nt.jsx)(At,{className:`hidden size-3.5 group-data-[state=checked]/checkbox:block`}),(0,Nt.jsx)(jt,{className:`hidden size-3.5 group-data-[state=indeterminate]/checkbox:block`})]})})};try{Pt.displayName=`checkboxRecipe`,Pt.__docgenInfo={description:"Style recipe for Checkbox. Slots: `root` (the box), `indicator` (the glyph).",displayName:`checkboxRecipe`,filePath:`/home/runner/work/design-system/design-system/src/checkbox/checkbox.tsx`,methods:[],props:{class:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`},{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`}],description:``,name:`class`,required:!1,tags:{},type:{name:`ClassNameValue`}},className:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`},{fileName:`design-system/node_modules/tailwind-variants/dist/types.d.ts`,name:`TypeLiteral`}],description:``,name:`className`,required:!1,tags:{},type:{name:`ClassNameValue`}}},tags:{}}}catch{}try{R.displayName=`Checkbox`,R.__docgenInfo={description:`Base control for a boolean the user confirms later: one item of a
...
@summary Legacy checkbox colours across all interaction states`,...$.parameters?.docs?.description}}},Rt=[`Default`,`Checked`,`Indeterminate`,`UncontrolledIndeterminate`,`Disabled`,`Invalid`,`WithLabel`,`Controlled`,`SelectAll`,`InsideSelectedGroup`,`LegacyStates`]}))();export{W as Checked,X as Controlled,U as Default,q as Disabled,G as Indeterminate,Q as InsideSelectedGroup,J as Invalid,$ as LegacyStates,Z as SelectAll,K as UncontrolledIndeterminate,Y as WithLabel,Rt as __namedExportsOrder,Lt as default};