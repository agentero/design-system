...
<span id="email-error">Enter a valid email address.</span>`}}}catch{}})),u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{l(),u=t(),{expect:d,userEvent:f,waitFor:p,within:m}=__STORYBOOK_MODULE_TEST__,h={title:`Components/Input`,component:c,tags:[`autodocs`],argTypes:{size:{control:`radio`,options:[`sm`,`md`,`lg`]},type:{control:`select`,options:[`text`,`email`,`password`,`number`,`tel`,`url`,`search`,`date`,`time`]},placeholder:{control:`text`},disabled:{control:`boolean`},readOnly:{control:`boolean`},required:{control:`boolean`},"aria-invalid":{control:`boolean`}},args:{type:`text`,placeholder:`Insert value`,"aria-label":`Value`},parameters:{docs:{description:{component:"Input is the base single-line text control. It is intentionally unaware of\nform fields and form libraries: `id`, `aria-invalid` and `aria-describedby`\nare plain props, set by a field wrapper or by hand.\n\nThere is no `status` prop. Mark the control `aria-invalid` and the\ndestructive border follows, so the styling can never disagree with what\nassistive technology announces."}}}},g={play:async({canvasElement:e})=>{let t=m(e).getByRole(`textbox`,{name:`Value`});await f.type(t,`Typed by the user`),await d(t).toHaveValue(`Typed by the user`)}},_={args:{size:`sm`}},v={args:{size:`md`}},y={args:{size:`lg`}},b={render:e=>(0,u.jsxs)(`div`,{style:{display:`grid`,gap:`1rem`,maxWidth:`20rem`},children:[(0,u.jsx)(c,{...e,size:`sm`,"aria-label":`Small input`,placeholder:`sm — 32px`}),(0,u.jsx)(c,{...e,size:`md`,"aria-label":`Medium input`,placeholder:`md — 40px`}),(0,u.jsx)(c,{...e,size:`lg`,"aria-label":`Large input`,placeholder:`lg — 48px`})]})},x={render:e=>(0,u.jsxs)(`div`,{style:{display:`grid`,gap:`1rem`,maxWidth:`20rem`},children:[(0,u.jsx)(c,{...e,type:`text`,"aria-label":`Text`,placeholder:`Text`}),(0,u.jsx)(c,{...e,type:`email`,"aria-label":`Email address`,placeholder:`you@example.com`}),(0,u.jsx)(c,{...e,type:`password`,"aria-label":`Password`,placeholder:`Password`}),(0,u.jsx)(c,{...e,type:`number`,"aria-label":`Amount`,placeholder:`0`}),(0,u.jsx)(c,{...e,type:`date`,"aria-label":`Date`,placeholder:``})]})},S={args:{type:`email`,"aria-label":`Email`,"aria-invalid":!0,"aria-describedby":`email-error`,defaultValue:`not-an-email`},render:e=>(0,u.jsxs)(`div`,{style:{display:`grid`,gap:`0.25rem`,maxWidth:`20rem`},children:[(0,u.jsx)(c,{...e}),(0,u.jsx)(`span`,{id:`email-error`,children:`Enter a valid email address.`})]}),play:async({canvasElement:e})=>{let t=m(e).getByRole(`textbox`,{name:`Email`});await d(t).toHaveAttribute(`aria-invalid`,`true`),await d(t).toHaveAccessibleDescription(`Enter a valid email address.`)}},C={args:{disabled:!0,defaultValue:`Cannot be edited`},play:async({canvasElement:e})=>{let t=m(e).getByRole(`textbox`,{name:`Value`});await d(t).toBeDisabled(),await f.type(t,`nope`),await d(t).toHaveValue(`Cannot be edited`)}},w={args:{readOnly:!0,defaultValue:`Copy me, but do not change me`},play:async({canvasElement:e})=>{let t=m(e).getByRole(`textbox`,{name:`Value`});await d(t).toHaveAttribute(`readonly`),await d(t).not.toBeDisabled();let n=getComputedStyle(t);await d(n.borderBottomWidth).toBe(`1px`),await d(n.borderTopWidth).toBe(`0px`),await d(n.borderLeftWidth).toBe(`0px`),await d(n.borderRadius).toBe(`0px`),await d(n.boxShadow).not.toMatch(/rgba\(\d+, \d+, \d+, 0\.\d+\)/),await f.tab(),await d(t).toHaveFocus();let r=getComputedStyle(t);await d(r.borderTopWidth).toBe(`1px`),await d(r.borderLeftWidth).toBe(`1px`),await d(r.borderRadius).toBe(`12px`),await p(()=>d(getComputedStyle(t).outlineWidth).toBe(`2px`))}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
...
}`,...g.parameters?.docs?.source},description:{story:`The default control at \`md\`, usable anywhere without a surrounding field.

@summary Default standalone input`,...g.parameters?.docs?.description}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'sm'
  }
}`,..._.parameters?.docs?.source},description:{story:`\`sm\` (32px) keeps dense layouts compact where vertical space is tight.

@summary Small 32px control for dense layouts`,..._.parameters?.docs?.description}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'md'
  }
}`,...v.parameters?.docs?.source},description:{story:`\`md\` (40px) is the default and covers standard form density.

@summary Medium 40px control, the default`,...v.parameters?.docs?.description}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'lg'
  }
}`,...y.parameters?.docs?.source},description:{story:"`lg` (48px) suits low-density forms and larger touch targets. It also raises\nthe text to `base` and the corner radius to `lg`.\n\n@summary Large 48px control for low-density forms",...y.parameters?.docs?.description}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
...
}`,...b.parameters?.docs?.source},description:{story:`All three heights together for visual comparison.

@summary Visual comparison of the three input sizes`,...b.parameters?.docs?.description}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: args => <div style={{
    display: 'grid',
    gap: '1rem',
    maxWidth: '20rem'
...
}`,...x.parameters?.docs?.source},description:{story:`A range of input types. The type picks the on-screen keyboard on touch
devices and the browser's own parsing, so set it even when you validate
yourself.

@summary Common input types side by side`,...x.parameters?.docs?.description}}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'email',
    'aria-label': 'Email',
    'aria-invalid': true,
...
}`,...S.parameters?.docs?.source},description:{story:`The invalid treatment comes purely from \`aria-invalid\`, so the border can
...
@summary Invalid state driven by aria-invalid`,...S.parameters?.docs?.description}}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    disabled: true,
...
}`,...C.parameters?.docs?.source},description:{story:`A disabled input keeps its value readable but blocks interaction, drops its
shadow and leaves the tab order.

@summary Disabled state`,...C.parameters?.docs?.description}}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
    readOnly: true,
...
}`,...w.parameters?.docs?.source},description:{story:`Read-only inputs stay focusable and copyable and still submit their value —
...
@summary Read-only value rendered as an underlined field`,...w.parameters?.docs?.description}}},T=[`Default`,`Small`,`Medium`,`Large`,`AllSizes`,`Types`,`Invalid`,`Disabled`,`ReadOnly`]}))();export{b as AllSizes,g as Default,C as Disabled,S as Invalid,y as Large,v as Medium,w as ReadOnly,_ as Small,x as Types,T as __namedExportsOrder,h as default};