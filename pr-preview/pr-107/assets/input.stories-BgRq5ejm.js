...
@summary Disabled state`,...S.parameters?.docs?.description}}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    await expect(style.boxShadow).not.toMatch(/rgba\\(\\d+, \\d+, \\d+, 0\\.\\d+\\)/);
  }
