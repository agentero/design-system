...
}`,..._.parameters?.docs?.source},description:{story:`Default args playground — enclosed (bordered) container.
...
}`,...v.parameters?.docs?.source},description:{story:"`enclosed={false}` drops the rounded border, letting the table sit flush\ninside a page or card (this is what `DataTable` uses).\n\n@summary enclosed=false — borderless",...v.parameters?.docs?.description}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    sticky: 'header',
    maxHeight: 220
  }
}`,...y.parameters?.docs?.source},description:{story:'`sticky="header"` pins the header row while the body scrolls; the divider\ntravels with it as a box-shadow. Needs a height cap (`maxHeight`) to scroll.\n\n@summary sticky="header" with a scrolling body',...y.parameters?.docs?.description}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...b.parameters?.docs?.source},description:{story:`\`sticky="headerAndFooter"\` pins both the header and the last body row (a
...
}`,...x.parameters?.docs?.source},description:{story:`\`embed\` removes the per-row dividers and pulls the edge cells in to a 1rem
...
}`,...S.parameters?.docs?.source},description:{story:`\`clean\` switches to separated borders with pill-rounded rows and a wider
edge gutter — a card-list look.

@summary clean — rounded, separated rows`,...S.parameters?.docs?.description}}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  render: args => renderTable(args, {
    checkbox: true
  })
}`,...C.parameters?.docs?.source},description:{story:`A leading checkbox column. Cells containing a checkbox collapse to zero width
...
}`,...w.parameters?.docs?.source},description:{story:`Hover-revealed row actions pinned to the trailing edge. The controls fade in
...
}`,...T.parameters?.docs?.source},description:{story:"Expandable rows: `Table.ExpandButton` toggles a `Table.ExpandedRow` detail\npanel beneath its parent row (the chevron rotates while open).\n\n@summary Expandable rows with a detail panel",...T.parameters?.docs?.description}}},E=[`Default`,`Borderless`,`StickyHeader`,`StickyHeaderAndFooter`,`Embed`,`Clean`,`WithCheckbox`,`WithRowActions`,`ExpandableRows`]}))();export{v as Borderless,S as Clean,_ as Default,x as Embed,T as ExpandableRows,y as StickyHeader,b as StickyHeaderAndFooter,C as WithCheckbox,w as WithRowActions,E as __namedExportsOrder,g as default};