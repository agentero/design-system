import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{n,t as r}from"./avatar-BS5D858Q.js";var i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{n(),i=t(),a={title:`Components/Avatar`,component:r,tags:[`autodocs`],parameters:{layout:`centered`,docs:{description:{component:"Avatar displays a user's profile image, initials, or a fallback icon.\nUse for user identification in lists, headers, cards, and comment threads.\nSupports multiple shapes (`circle`, `square`, `pillow`, `pentagon`),\ncontent types (`photo`, `initials`, `isotype`), and sizes from `xs` (24px)\nto `4xl` (128px)."}}},argTypes:{size:{control:`select`,options:[`xs`,`sm`,`md`,`lg`,`xl`,`2xl`,`3xl`,`4xl`]},variant:{control:`radio`,options:[`circle`,`square`,`pillow`,`pentagon`]},type:{control:`radio`,options:[`photo`,`initials`,`isotype`],description:"Content type the avatar represents. `photo` fills the shape, `initials` shows text, `isotype` renders a brand icon smaller than the shape so it sits centered inside."}},args:{fallback:`JD`,size:`md`,variant:`circle`,type:`photo`}},o={},s={args:{src:`https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?&w=256&h=256&q=70&crop=focalpoint&fp-x=0.5&fp-y=0.3&fp-z=1&fit=crop`,alt:`Alex Morgan`}},c={args:{src:`https://broken-url.example/photo.jpg`,fallback:`AM`}},l={args:{variant:`circle`,fallback:`CR`}},u={args:{variant:`square`,fallback:`WS`}},d={args:{variant:`pillow`,fallback:`PL`}},f={args:{variant:`pentagon`,fallback:`PT`}},p={args:{type:`photo`,src:`https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?&w=256&h=256&q=70&crop=focalpoint&fp-x=0.5&fp-y=0.3&fp-z=1&fit=crop`,alt:`Alex Morgan`,fallback:`AM`}},m={args:{type:`initials`,fallback:`JD`}},h={args:{type:`isotype`,variant:`square`,src:`https://cdn.simpleicons.org/figma`,alt:`Figma`,fallback:`FG`}},g={render:()=>(0,i.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,i.jsx)(r,{size:`lg`,type:`photo`,src:`https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?&w=256&h=256&q=70&crop=focalpoint&fp-x=0.5&fp-y=0.3&fp-z=1&fit=crop`,alt:`Alex Morgan`,fallback:`AM`}),(0,i.jsx)(r,{size:`lg`,type:`initials`,fallback:`JD`}),(0,i.jsx)(r,{size:`lg`,type:`isotype`,variant:`square`,src:`https://cdn.simpleicons.org/figma`,alt:`Figma`,fallback:`FG`})]})},_={render:()=>(0,i.jsx)(`div`,{className:`flex items-center gap-4`,children:[`xs`,`sm`,`md`,`lg`,`xl`,`2xl`,`3xl`,`4xl`].map(e=>(0,i.jsx)(r,{size:e,type:`isotype`,variant:`square`,src:`https://cdn.simpleicons.org/figma`,alt:`Figma`,fallback:`FG`},e))})},v={args:{size:`xs`,fallback:`XS`}},y={args:{size:`sm`,fallback:`SM`}},b={args:{size:`lg`,fallback:`LG`}},x={args:{size:`xl`,fallback:`XL`}},S={args:{colorize:`jane doe`,fallback:`JD`}},C={render:()=>(0,i.jsx)(`div`,{className:`flex items-center gap-4`,children:[`alice`,`bob`,`carol`,`dave`,`eve`,`frank`,`grace`,`henry`,`iris`].map(e=>(0,i.jsx)(r,{size:`lg`,colorize:e,fallback:e.slice(0,2).toUpperCase()},e))})},w={render:()=>(0,i.jsx)(`div`,{className:`flex items-center gap-4`,children:[`xs`,`sm`,`md`,`lg`,`xl`,`2xl`,`3xl`,`4xl`].map(e=>(0,i.jsx)(r,{size:e,fallback:e.toUpperCase()},e))})},T={render:()=>(0,i.jsx)(`div`,{className:`flex items-center gap-4`,children:[`xs`,`sm`,`md`,`lg`,`xl`,`2xl`,`3xl`,`4xl`].map(e=>(0,i.jsx)(r,{size:e,src:`https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?&w=256&h=256&q=70&crop=focalpoint&fp-x=0.5&fp-y=0.3&fp-z=1&fit=crop`,alt:`Alex Morgan`,fallback:`AM`},e))})},E={render:()=>(0,i.jsx)(`div`,{className:`flex items-center gap-4`,children:[`circle`,`square`,`pillow`,`pentagon`].map(e=>(0,i.jsx)(r,{size:`lg`,variant:e,fallback:e.slice(0,2).toUpperCase()},e))})},D={render:()=>(0,i.jsx)(`div`,{className:`flex items-center gap-4`,children:[`circle`,`square`,`pillow`,`pentagon`].map(e=>(0,i.jsx)(r,{size:`lg`,variant:e,src:`https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?&w=256&h=256&q=70&crop=focalpoint&fp-x=0.5&fp-y=0.3&fp-z=1&fit=crop`,alt:`Alex Morgan`,fallback:`AM`},e))})},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{}`,...o.parameters?.docs?.source},description:{story:`The default avatar with fallback initials. Renders as a medium circle
