...
<Divider label="or" />
<Divider decorative={false} />`}}}catch{}})),A,j,M,N,P,F,I,L,R,z,B,V,H;e((()=>{c(),f(),k(),A=i(),j={title:`Components/Divider`,component:O,tags:[`autodocs`],argTypes:{orientation:{control:`radio`,options:[`horizontal`,`vertical`]},decorative:{control:`boolean`},label:{control:`text`}},args:{orientation:`horizontal`,decorative:!0},parameters:{docs:{description:{component:`Divider separates content visually along either a horizontal or vertical
